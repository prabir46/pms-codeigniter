...
//alert (JSON.stringify(option.theme));
...
//alert (JSON.stringify(scollDayEvents));
...
//alert (JSON.stringify(events));
            ...
            for (var i = 0; i < countHours; i++) {
                ...
                ht.push("<div style=\"height: 40px\" class=\"tg-time\">", tmt, "</div>");
            }
            ht.push("</td>");
            var l = dayarrs.length;
...
//alert (JSON.stringify(theme));
        ...
        function gH(y1, y2, pt) {//create new event
            ...
            var tw = (sy1 - pt) / (42 * n);
var tw1=(sy1 - pt) / (84);
var pr=tw1.toFixed(1);
var src_str=pr.toString();
var str_spl = src_str.split(".");
if(str_spl[1] >= 5){
wt_inch = Math.ceil(tw);
}else{
wt_inch = Math.floor(tw);
}
tdf=Number(wt_inch);
...
//alert("#" + d.substring(c * 30 + i * 6, c * 30 + (i + 1) * 6));
//alert("#" + d.substring(c * option.intervalTime + i * 6, c * option.intervalTime + (i + 1) * 6));
