...
<section class="content-header">
    <h1>
       <?php echo lang('medical_test');?>
        <small><?php echo lang('edit');?></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo site_url('admin')?>"><i class="fa fa-dashboard"></i> <?php echo lang('dashboard');?></a></li>
        <li><a href="<?php echo site_url('admin/medical_test')?>"> <?php echo lang('medical_test');?></a></li>
...
<?php  } ?>  
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
				...
				<?php echo form_open_multipart('admin/medical_test/edit/'.$id); ?>
                    <div class="box-body">
                        <div class="box-body">
