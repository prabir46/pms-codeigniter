      ...
      <div class="modal-body">
	   <div id="err">  
		...
		<?php  } ?>  
      				   ...
      				   <!-- form start -->
				<form method="post" action="<?php echo site_url('admin/inventory_management/update/'.$ids)?>" enctype="multipart/form-data" id="add_form">
...
<div class="form-group">
                        	<div class="row">
								...
								<div class="col-md-4">
                                    <input type="text" name="price" value="<?php echo $inventory_management->price; ?>" class="form-control price" />
                                </div>
                            </div>
                        </div>
	...
	echo '<option value="'.$new->id.'" '.$sel.'>'.$new->name.'</option>';
						 ...
						 <div class="form-group">
                        	<div class="row">
								...
								<div class="col-md-4">
	<input type="text" name="dates" value="<?php echo $inventory_management->dates; ?>" class="form-control datetimepicker">
                                </div>
                            </div>
                        </div>
...
$( "#add_form" ).submit(function( event ) {
	...
	call_loader_ajax();
	$.ajax({
		url: '<?php echo base_url('admin/inventory_management/update/'.$ids) ?>',
		type:'POST',
