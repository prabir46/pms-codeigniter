...
<?php  } ?>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
				...
				<?php echo form_open_multipart('admin/medical_college/select_medical_college/'.$view); ?>
                    <div class="box-body">
                        <div class="form-group">
                        	<div class="row">
                                <div class="col-md-4">
                                 	<select name="college_id" class="form-control chzn">
											<option value="">--<?php echo lang('select');?> <?php echo lang('medical_college');?>--</option>
											<?php foreach($colleges as $new) {
													$sel = "";
