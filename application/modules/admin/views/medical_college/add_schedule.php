...
<?php  } ?>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
				...
				<?php echo form_open_multipart('admin/medical_college/add_schedule/'.$h_id); ?>
                    <div class="box-body">
                        <div class="form-group">
                        	<div class="row">
                                ...
                                <div class="col-md-2">	
									<input type="text" name="end" value=""  placeholder="05:00 am" class="form-control timepicker">
								</div>
                                
                                <div class="col-md-3">	
									<input type="text" name="work" value=""  placeholder="<?php echo lang('work');?> " class="form-control">
								</div>
												...
												<div class="">
													 <div class="col-sm-2 effect left_to_right subjectMotherDiv">
														...
														<div class="info">
															...
															<a class="btn btn-xs red buttonMargin btn-danger" href="<?php echo site_url('admin/medical_college/delete_week_schedule/'.$data->id.'/'.$this->uri->segment(4)); ?>"  onclick="javascript:return confirm('Are you sure you want to delete this schedule');"> <i class="fa fa-trash-o"></i><?php echo lang('delete');?> </a>
  ...
  <div class="modal-dialog">
    <div class="modal-content ff">
      ...
      <div class="modal-body">
				<?php echo form_open_multipart('admin/medical_college/edit_schedule/'.$schedule->id.'/'.$this->uri->segment(4)); ?>
                    <div class="box-body">
                        <div class="form-group">
                        	<div class="row">
                                <div class="col-md-3">
								...
								<div class="col-md-2">	
									...
									<input type="text" name="start" value="<?php echo $schedule->timing_from; ?>"  placeholder="Start Time" class="form-control timepicker">
									</div>
                                </div>
                                
                                <div class="col-md-2">	
									<div class="bootstrap-timepicker">   
									<input type="text" name="end" value="<?php echo $schedule->timing_to; ?>"  placeholder="Start Time" class="form-control timepicker">
									</div>
                                </div>
