	...
	<div class="row no-print" style="margin-bottom:10px;">
            <div class="col-xs-12">
                <div class="btn-group pull-right">
                    <a class="btn btn-default nnn" href="#add" data-toggle="modal"><i class="fa fa-plus"></i> <?php echo lang('add') ." ". lang('payment');?></a>
                </div>
            </div>    
        </div>	
                            ...
                            <?php $i=1;foreach ($fees_all as $new){?>
                                <tr class="gc_row">
                                    ...
                                    <td width="30%">
										 ...
										 <a class="btn btn-danger" style="margin-left:20px;" href="<?php echo site_url('admin/payment/delete_payment/'.$new->id.'/'.$this->uri->segment(4)); ?>" onclick="return areyousure()"><i class="fa fa-trash"></i> <?php echo lang('delete')?></a>
								...
								<td>
									<table  width="100%" style="border:1px solid #CCCCCC;" >
										...
										<tr >
											 ...
											 <td width="75%" style="border-right:1px solid #CCCCCC"><?php echo lang('prescription_fee') ?></td>
      ...
      <div class="modal-body">
	   <div id="err">  
		...
		<?php  } ?>  
      				   ...
      				   <!-- form start -->
				<form method="post" action="<?php echo site_url('admin/payment/add_payment/'.@$p_id)?>" enctype="multipart/form-data" id="add_form">
