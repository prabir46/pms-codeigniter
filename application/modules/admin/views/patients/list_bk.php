        ...
        <div class="col-xs-12">
            <div class="btn-group pull-right">
                <a class="btn btn-default" href="#add" onclick="{
                                    $('td.xdsoft_today').trigger('click.xdsoft');
                                }" data-toggle="modal"><i class="fa fa-plus"></i> <?php echo lang('add_new') ?> </a>
                    ...
                    <form method="post">
                        ...
                        <div class="col-xs-5">
                            <select name="filter_id" class="form-control" >
                                ...
                                <option value="contact" <?php echo (@$_POST['filter_id'] == "contact") ? 'selected="selected"' : ''; ?>>Telephone Number2</option>
