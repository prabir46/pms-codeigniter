                                                    ...
                                                    foreach ($fees_all as $new) {
                                                        ...
                                                        <tr class="gc_row">
                                                            ...
                                                            <td >
                                                                ...
                                                                <a class="btn  btnPaymentNote 
                                                                <?php if ($new->payment_notes != "") {
                                                                    echo "btn-success";
                                                                }else{
                                                                    echo "btn-danger";
                                                                }?>" type="paymentAddNoteButton" id="paymentAddNoteButton" value = "paymentAddNoteButton" style="float:right; color:#FFFFFF; margin-right:10px" data-id='<?php echo json_encode($new); ?>' data-toggle="modal" data-target="#add_PaymentNote">Notes</a>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                        $i++;
                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" action="<?php echo site_url('admin/payment/edit_payment_new/' . $payment->id) ?>" enctype="multipart/form-data" onsubmit="return validateForm()">
                            ...
                            <div class="form-group input_fields_wrap2">
                                <?php
                                $treatment_Advised_id = json_decode($payment->treatment_Advised_id);
                    ...
                    <div class="form-group input_fields_wrap2 consultation_charge">
                        <div class="form-group" style="margin-top:20px;">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                <input type="text" class="form-control" name="consultation_charge">
                                    ...
                                    <tr>
                                        <td >
                                            <table width="100%" style="border-bottom:1px solid black">
                                                <tr>
                                                    <td><b>Patient <?php echo lang('name') ?></b> : <?php echo substr($patient->name, 0, 20) ?></td>
                                                    <td style="text-align:right"><b>Date</b> : <?php echo date('d/m/Y', strtotime($patient->add_date)) ?></td>
                                                </tr>
                                                <tr>
                                                    <td ><b>Patient <?php echo lang('id') ?></b> : <?php echo $patient->id ?></td>
                                                    <td style="text-align:right"><b><?php echo lang('age') ?></b> : <?php echo date("Y") - $patient->dob ?> Years</td>
                                                    ...
                                                    foreach ($d as $key => $new) {
                                                        if (!empty($d[$key])) {
                                                           echo '<tr><td><p style="padding-left:32px;">' . $d[$key].'</p></td>';
                                                            ...
                                                            echo '<td><p style="padding-left:32px;">' . @$duration[$key] . '</p></td></tr>';
                                                        }
                                                        $i++;
                                                    }
                                                } else {
                        ...
                        <?php if (empty($_POST['medicine_id'])) { ?>
                            <div class="form-group input_fields_wrap">
                                <div class="row  ">
                                    ...
                                    <div class="col-md-2" >
                                        <div>
                                            <select name="medicine_id[]" class="form-control  add-medicine_id">
                                                <option value="">--<?php echo lang('select_medicine'); ?>--</option>
                                                <?php
                                                foreach ($medicines as $new) {
                                                    $sel = "";
                                    ...
                                    <div class="col-md-2 ">
                                        <select name="instruction[]" class="form-control add-instruction">
...
<div class="modal fade" id="add_PaymentNote" tabindex="-1" role="dialog" aria-labelledby="addlabel" aria-hidden="true">
    ...
    margin-right: 20px;"> <?php echo  date("Y-m-d");?></span> </h4>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" id="btnSubmitPaymentNote">Submit</button>  
            </div>
        </div>
                    </div>
    </div>
...
<?php echo lang('select_medicine'); ?>--</option><?php
    ...
    $(document).ready(function () {
        ...
        $(add_button).click(function (e) { //on add input button click
            ...
            if (x < max_fields) { //max input box allowed
                ...
                x++; //text box increment
                $(wrapper).append('<div class="row"><div class="col-md-2"></div><div class="col-md-4"><select name="report_id_' + x + '" class="form-control chzn add-report_id"><option value="">--<?php echo lang('select_medical_test'); ?>--</option><?php
                    foreach ($tests as $new) {
                        echo '<option value="' . $new->name . '">' . $new->name . '</option>';
                    }
                    ?></select></div><div class="col-md-4"><select name="test_instruction_' + x + '" class="form-control chzn add-test_instruction"><option value="">--<?php echo lang('medical_test_instruction'); ?>--</option><?php
                    foreach ($test_ins as $new) {
                        echo '<option value="' . $new->name . '">' . $new->name . '</option>';
                    }
    ...
    $(document).ready(function () {
        ...
        $(add_button).click(function (e) { //on add input button click
            ...
            if (x < max_fields) { //max input box allowed
                x++; //text box increment
                $(wrapper).append('<div class="row"><div class="col-md-2"></div><div class="col-md-4"><select name="treatment_Advised_id_' + x + '" class="form-control chzn add-treatment_advised_id"><option value="">--<?php echo lang('Treatment_Advised'); ?>--</option><?php
                    foreach ($treatment_Advised_tests as $new) {
                        echo '<option value="' . $new->name . '">' . $new->name . '</option>';
                    }
                    ?></select></div><div class="col-md-4"><select name="treatment_Advised_instruction_' + x + '" class="form-control chzn add-treatment_advised_instruction"><option value="">--<?php echo lang('treatment_Advised_instruction'); ?>--</option><?php
                    foreach ($treatment_Advised_ins as $new) {
                        echo '<option value="' . $new->name . '">' . $new->name . '</option>';
                    }
                    ?></select></div><a href="#" class="remove_field1 btn btn-danger"><?php echo lang('remove'); ?></a></div></div>'); //add input box
    ...
    $(document).ready(function () {
        ...
        $(add_button).click(function (e) { //on add input button click
            ...
            if (x < max_fields) { //max input box allowed
                x++; //text box increment
                $(wrapper).append('<div class="row"><div class="col-md-2"></div><div class="col-md-4"><select name="intra_Oral_' + x + '" class="form-control chzn"><option value="">--<?php echo 'Select an option'; ?>--</option><?php
                    foreach ($intra_Oral_Exm as $new) {
                        echo '<option value="' . $new->name . '">' . $new->name . '</option>';
                    }
                    ?></select></div><div class="col-md-4"><select name="intra_Oral_Exm_' + x + '" class="form-control chzn" multiple="multiple" data-placeholder="Select an option"><?php
                    foreach ($treatment_Advised_ins as $new) {
                        echo '<option value="' . $new->name . '">' . $new->name . '</option>';
                    }
