			   			 ...
			   			 <div class="form-group">
                              <div class="row">
                                <div class="col-md-6">
									...
									<input type="text" name="dob" value="<?php echo set_value('dob')?>" class="form-control">
						...
						<div class="form-group">
			   			 ...
			   			 <div class="form-group">
                              <div class="row">
                                <div class="col-md-4">
                                    <label for="dob" style="clear:both;"><?php echo lang('date_of_birth')?></label>
									<input type="text" name="dob" id="datepicker" value="<?php echo date("Y")-$patient->dob?>"class="form-control datepicker">
