                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body" style="margin-bottom:0; padding-bottom:0;" id="printreg<?php echo $patient->id; ?>">
                                                            <?php
                                                            if (strpos($llate->header, 'http://') === false && strpos($template->header, 'https://') === false) {
                                                                        ...
                                                                        <table width="100%" style="border-bottom:1px solid;">
                                                                            <tr>
                                                                                <td style="line-height:110%">
                                                                                    <?php
                                                                                    if (strpos($pres_template->header, 'http://') === false && strpos($pres_template->header, 'https://') === false) {
                                                                                        echo $pres_template->header;
                                                                                    } else {
                                                                                        echo '<img src="' . $pres_template->header . '" width="100%" height="auto" />';
                                                                                    }
                                                                                    ?>
                                                                                </td>
                                            ...
                                            <div class="col-md-4" style="overflow: hidden;">
                                                <table class="table table-bordered table-striped dataTable" >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo $patient->group; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>Medical History</th>
                                                        <td><?php
                                                            $arr = json_decode($patient->medical_History);
                                                            $i = 1;
                                                            $count = sizeof($arr);
                                                            foreach ($arr as $new) {
                                                                echo $new;
...
//print_r($docter_name);
													...
													$cancelStaus = '';
													$appointCancel=$this->patient_model->getCancelAppointment($new->id);
													if(count($appointCancel) > 0)
													{
														//echo '<pre>appointCancel: '; print_r($appointCancel); echo '</pre>';
														$Color = $appointCancel[0]->Color;
														$motive = $appointCancel[0]->motive;														
														if (strpos($motive, 'Cancel by') !== false) {
															$cancelStaus = '<span style="color:#F00;">(Appointments '.$motive.')</span>';
														}
													}
                                                    if ($new->other != 0 || $new->other != "") {
                                                        ...
                                                        <div class="comment_box">
                                                            ...
                                                            <p>Treatment done by <?php echo $docter_name; ?> <?php echo $cancelStaus; ?> </p>  <a class="btn btn-success btnEditNote"  style="float:right; color:#FFFFFF; margin-right:10px" data-id='<?php echo json_encode($new); ?>' data-toggle="modal" data-target="#add"> Edit Notes</a>   <a class="btn btn-success btnAddNote"  href="#add" data-id= "<?php echo $new->id; ?>" data-toggle="modal" data-target="#add" style="float:right; color:#FFFFFF; margin-right:10px"> Add Notes</a>
                                                            <p><?php echo $new->other ?></p> 
                                                            <p><?php echo $new->notes ?></p>
                                                        </div>
                                                    <?php } else { ?>
                                                        <div class="comment_box">
                                                            <p>Apointment with <?php echo $docter_name; ?> at <?php echo $expo[1]; ?> <?php echo $cancelStaus; ?></p> <a class="btn btn-success"  style="float:right; color:#FFFFFF; margin-right:10px"> Edit Notes</a>   <a class="btn btn-success"  style="float:right; color:#FFFFFF; margin-right:10px"> Add Notes</a>
                                                            <p><?php echo $new->other ?></p> 
                                                            <p></p>
                                                        </div>
                                                        <?php
                                    ...
                                    <div class="tab-pane <?php echo ($tab == "medication_history") ? 'active' : ''; ?>" id="tab_2">
                                        <div class="box box-solid">
                                            <div class="box-header">
                                                ...
                                                <a href="javascript:void(0);" class="btn btn-default" style="float:right" id="add_prescription_popup"> <i class="fa fa-plus"></i> Add Prescription</a>
                                            </div>

                                            <div class="box-body border-radius-none">
                                                <table id="example12" class="table table-bordered table-striped"><!--example1-->
                                                    <thead>
                                                    <tr>
                                                                ...
                                                                <td width="45%">
                                                                    <div class="btn-group pull-right">
                                                                        ...
                                                                        if ($admin['user_role'] == 1) {
                                                                            ?>
                                                                            <a class="btn btn-primary" style="margin-left:10px;"  href="javascript:void(0);" onclick="showModal('reports<?php echo $new->id ?>');"> <i class="fa fa-file"></i> <?php echo lang('reports'); ?></a>
                                                                            <a class="btn btn-primary" style="margin-left:10px;"  href="javascript:void(0);" onclick="showModal('myModal<?php echo $new->id ?>');"><i class="fa fa-eye"></i> <?php echo lang('view'); ?> <?php echo lang('prescription') ?></a>
                                                                            <a class="btn btn-primary" style="margin-left:10px;"  href="javascript:void(0);" onclick="showModal('edit_prescription<?php echo $new->id ?>');"><i class="fa fa-edit"></i> <?php echo lang('edit'); ?> </a>
                                                                        ...
                                                                        <?php } else { ?>
                                                                            <a class="btn btn-primary" style="margin-left:10px;"  href="javascript:void(0);" onclick="showModal('report<?php echo $new->id ?>');"> <i class="fa fa-file"></i> <?php echo lang('reports'); ?></a>
                                                                            <a class="btn btn-primary" style="margin-left:10px;"  href="javascript:void(0);" onclick="showModal('myModal<?php echo $new->id ?>');"><i class="fa fa-eye"></i> <?php echo lang('view'); ?> <?php echo lang('prescription') ?></a>
                                        ...
                                        <div class="box-body border-radius-none">
                                            ...
                                            <table id="" class="table table-bordered table-striped table-mailbox">
                                                ...
                                                <tr>
                                                    ...
                                                    <th><?php echo 'Treatment Advise' ?></th>
                                                    <th><?php echo 'Teeth' ?></th>
                                                    ...
                                                    foreach ($fees_all as $new) {
                                                        ...
                                                        <tr class="gc_row">
                                                                ...
                                                                <td><?php
                                                                  ...
                                                                  //  if ($th1[0] != 'D') {
                                                                       // for ($i = 0; $i < count($th1); $i++) {
                                                                            echo $new->treatment_Advised_id;
                                                                           // if ($i != count($th1) - 1)
                                                                              //  echo ', ';
                                                                      //  }
                                                                    }
                                                                    ?></td>
                                                                    <td><?php echo $new->teeth; ?></td>
                                                            <?php if($new->credit==0){ ?>
                                                             <td>-</td>
                                                             <?php } else { ?>
                                                            <?php if ($new->payment_mode_id == 1 || $new->payment_mode_id == '') { ?>
                                                                <td>Cash</td>
                                                            <?php } ?>
                                                            ...
                                                            <td >
                                                                ...
                                                                <input type="text" hidden value="<?php echo json_encode($new); ?>" id="selectedData">
                                                                <a class="btn btn-success btnPaymentNote" type="paymentAddNoteButton" id="paymentAddNoteButton" value = "paymentAddNoteButton" style="float:right; color:#FFFFFF; margin-right:10px" data-id='<?php echo json_encode($new); ?>' data-toggle="modal" data-target="#add_PaymentNote">Notes</a>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                        $i++;
                                            ...
                                            <?php
                                                ...
                                                <a class="btn" style="background-color: #3c8dbc; color: #fff;" href="javascript:void(0);" onclick="open_print_invoice('invoiceall');">Print Invoice</a>
                                        ...
                                        <div class="box box-solid">
                                            ...
                                            <div class="box-body border-radius-none">
                                                <table id="example3" class="table table-bordered table-striped">
                                                    ...
                                                    <?php
                                                    $i = 1;
                                                    foreach ($reports as $prescription) {
                                                        //if($prescription)
                                                        ?>
                                                        <tr class="gc_row">
                                    ...
                                    <div class="tab-pane <?php echo ($tab == "treatment_plan") ? 'active' : ''; ?>" id="tab_9">
                                        ...
                                        <div class="box-body border-radius-none">
                                            ...
                                            <table id="example2" class="table table-bordered table-striped table-mailbox">
                                                ...
                                                foreach ($tooth_list as $new) {
                                                    ...
                                                    <tr class="gc_row">
                                                        ...
                                                        <td><?php
                                                            ...
                                                            ?></td>
                                                            <td><?php
                                                            print_r($new->quantity)
                                                            ?></td>
                                                            <td><?php
                                                            print_r($new->estimate)
                                                            ?></td>


                                                        <td width="30%">

                                                            <?php /*?><a class="btn btn-primary" style="margin-left:10px;"  href="#edit_invoice<?php echo $new->id; ?>" data-toggle="modal"><i class="fa fa-edit"></i> <?php echo lang('edit'); ?></a><?php */?>
                                                            <a class="btn btn-primary" style="margin-left:10px;"  href="javascript:void(0);" data-id="<?php echo $new->id; ?>" onclick="getTreatmentPlan('<?php echo $new->id; ?>');"><i class="fa fa-edit"></i> <?php echo lang('edit'); ?></a>
                                                            <a class="btn btn-danger" style="margin-left:20px;" href="<?php echo site_url('admin/payment/delete_tooth/' . $new->id . '/' . $this->uri->segment(4)); ?>" onclick="return confirm('Are You Sure')"><i class="fa fa-trash"></i> <?php echo lang('delete') ?></a><a class="btn btn-default" style="margin-left:20px;" href="#invoice<?php echo $new->id; ?>"  data-toggle="modal"><i class="fa fa-list"></i></a>
                                                ...
                                                <a class="btn" style="background-color: #3c8dbc; color: #fff;" href="#invoiceall1" data-toggle="modal">Print Estimate</a>
                                        </div><!-- /.box-body -->
                                    </div><!-- /.tab-pane -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php
                        $reports = $this->prescription_model->get_reports_by_id($pre->id);
                        if (isset($reports)):
                            ?>
			  ...
			  <div class="modal-body" width="auto">
                ...
                <form method="post" action="<?php echo site_url('admin/payment/edit_payment_new/' . $payment->id) ?>" enctype="multipart/form-data" onsubmit="return validateForm()">
                    ...
                    <div class="form-group" >
                        <div class="row">
                            <div class="col-md-2">
                                <select name="consultant" class="form-control consultant_id " >
                                    <?php
                                    foreach ($consultant_copy as $new) {
                                        $sel = "";
										if($payment->consultant == $new->id)
											$sel = " selected='selected' ";
                                        echo '<option  id="' . $new->Color . '" value="' . $new->id . '" '.$sel.'>' . $new->name . '</option>';
                                    }
                                    ?>
                            ...
                            <div class="col-md-2">
                                <input type="text" name="date1" value="<?php echo date('d/m/Y', strtotime($payment->dates)); ?>" class="form-control" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group" style="margin-top:20px;">
                    ...
                    <div class="input_field_inv_add"><!--input_field_inv_1-->
                        <div class="form-group" style="margin-top:20px;">
                            <div class="row">
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    <?php echo $payment->treatment_Advised_id;?>
                                </div>
                                <div class="col-md-2">
                                    <?php echo $payment->teeth; ?>
                                </div>
                                <?php
								$receipt = strpos($payment->invoice, 'RCT');
								if ($receipt !== false) {
								   ?>
								   <div class="col-md-1"><?php echo $payment->qty; ?></div>
                                    <div class="col-md-3">
                                        <?php echo $payment->rate; ?>
                                        <span style="float:right;"><?php echo $payment->amount; ?></span>
                                    </div>
                                    <div class="col-md-2"><?php echo $payment->credit; ?></div>
								   <?php
								}
								else
								{
								?>
                                <div class="col-md-1">                                    
                                    <input type="text" id="edit_qty_<?php echo $payment->id ?>" name="edit_qty_<?php echo $payment->id ?>" value="<?php echo $payment->qty; ?>" class="form-control" style="padding:2px;" onkeyup="calclulate_edit_total('<?php echo $payment->id ?>');" />
                                </div>
                                <div class="col-md-3">
                                    <input style="padding: 2px; width:45%; float:left;" type="text" id="edit_rate_<?php echo $payment->id ?>" name="edit_rate_<?php echo $payment->id ?>" value="<?php echo $payment->rate; ?>" class="form-control" onkeyup="calclulate_edit_total('<?php echo $payment->id ?>');" />
									<input style="padding: 2px; width:45%; float:right;" type="text" id="edit_amount_<?php echo $payment->id ?>" name="edit_amount_<?php echo $payment->id ?>" value="<?php echo $payment->amount; ?>" class="form-control" onkeyup="calclulate_edit_total('<?php echo $payment->id ?>');" />
                                </div>
                                <div class="col-md-2">
                                    <input type="text" id="edit_credit_<?php echo $payment->id ?>" name="edit_credit_<?php echo $new->id ?>" value="<?php echo $payment->credit; ?>" class="form-control" onkeyup="calclulate_received_total('<?php echo $payment->id ?>');" />
                                </div>
								<?php
								}?>
                            </div>
                    ...
                    <div class="form-group" style="margin-top:20px;">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="amount" id="edit_amount_pay_<?php echo $payment->id ?>" value="<?php echo ($payment->credit); ?>"   class="form-control amount" />
    ...
    <div class="modal-dialog dd">
        ...
        <div class="modal-content ff">
            ...
            <div class="modal-body" width="auto">
                ...
                <form id="demo123" method="post" action="<?php echo site_url('admin/payment/add_payment_inv/' . @$id) ?>" enctype="multipart/form-data">
                    <div class="form-group" style="margin-top:20px;">
                        <div class="row">
                            <div class="col-md-2">
                                <b><?php echo lang('consultant') ?></b>
                    ...
                    <div class="input_field_inv_1">
                        <div class="form-group" style="margin-top:20px;">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <select name="treatment_Advised_id[]" class="form-control chzn" onchange="updatePrice(this, 1)" > <!--multiple="multiple"-->
                                        <option value="">--<?php echo lang('treatment_advised'); ?>--</option>

                                        <?php
                                        foreach ($treatment_Advised as $new) {
                                            $sel = "";
                                            if (set_select('treatment_Advised_id', $new->name))
                                                $sel = "selected='selected'";
                                            ?>
                                ...
                                <div class="col-md-2">
                                    <input type="text" id="tooth" value="" class="form-control amount" style="cursor:pointer;" onclick="{
                                                teeth_row = 0;
                                ...
                                <div class="col-md-1">
                                    <input type="text" id="qty1" name="qty[]" value="" class="form-control amount" style="padding:2px;" />
                                </div>
                                <div class="col-md-3">

                                    <input type="text" id="amt1" name="rate[]" value="" class="form-control amount" style="padding: 2px; width:45%; float:left;" />
									<input type="text" id="qty_rate1" name="qty_rate[]" value="" class="form-control amount" style="padding: 2px; width:45%; float:right;" />
                                </div>
                                <div class="col-md-2">
                                    <input type="text" id="ashu" name="amount12[]" value=""  class="form-control amount" placeholder="Amount"/>
                                </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="pull-right" style="padding-left:12px;">
                                <button class="add_field_button_invoice_1 btn btn-success"><?php echo lang('add'); ?> </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <center><div class="col-md-12"><b>Add Payment</b></div></center>
                    <hr/>
                    <div class="row">
                        <div class="col-md-2">
                            <b>Payment Mode</b>
                        </div>
                        <div class="col-md-2"> <b>Card No.</b></div>
                        <div class="col-md-2"> <b>Bank Name</b></div>
                        <div class="col-md-2"><b>Cheque No.</b></div>
                        <div class="col-md-2"><b>Payment By</b> </div>
                    </div>
                    <div>
                        <div class="input_field_inv">
                            <div class="form-group" style="margin-top:20px;">
                                <div class="row">
                                    <div class="col-md-2">
                                        <select name="payment_mode_id[]" class="form-control payment payment_mode_id" onchange="payment_made_inv(this);" >
                                            <option value="">--<?php echo lang('select') ?> <?php echo lang('payment_mode') ?> --</option>
                                            <?php
                                            foreach ($payment_modes as $new) {
                                                $sel = "";
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="box-footer">
                                <button  type="submit" class="btn btn-primary pull-left"><?php echo "Save Invoice + Payments" ?></button>
                                <button class="add_field_button_invoice btn btn-success pull-right"><?php echo lang('add'); ?> </button>
                            </div>
...
?>
                    ...
                    <div class="col-md-12"><b>Add Payment</b></div>
                    <hr/>
                    <div class="row">
                        <div class="col-md-4">
                            <b>Amount</b>
                        ...
                        <div class="col-md-4"> <b>Card No.</b></div>
                    ...
                    <div>
                        <div class="input_field_inv">
                            <div class="form-group" style="margin-top:20px;">
                                <div class="row">
                                    <div class="col-md-4">
                                        <input type="text" name="amount[]" value=""  class="form-control amount" placeholder="Ammount"/>
                                    </div>
                                    <div class="col-md-4">
                                        <select name="payment_mode_id[]" class="form-control payment payment_mode_id" onchange="payment_made_inv(this);" >
                                            <option value="">--<?php echo lang('select') ?> <?php echo lang('payment_mode') ?> --</option>
...
?>
                    ...
                    <div class="box-footer">
                        <button  type="submit" class="btn btn-primary"><?php echo "Save Invoice + Payments" ?></button>
                    </div>
                </form>
...
<script type="text/javascript">
    function updatePrice(select, n) {
		...
		var rateAmt = rate*qty;
		//console.log('n => '+n+' => Qty => '+qty+' Rate => '+rate+' rateAmt => '+rateAmt);
		
		if(qty == '' || rate == '')
			$("#qty_rate"+n).val('');
		else
			$("#qty_rate"+n).val(rateAmt);
    }
</script>
<?php //===========================payment==============================================================  ?>
<!-- Add Payment-->
                ...
                <form method="post" action="<?php echo site_url('admin/payment/add_payment_new/' . @$id) ?>" enctype="multipart/form-data">
                    ...
                    <?php /*?><div class="form-group" >
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <select  name="inv" class="form-control chzn consultant_id " >
                    ...
                    <?php /*?><div class="form-group">
                        <div class="row">
                            <div class="col-md-2">
                                <label><input type="checkbox" name="wish" value="1">Add Treatment Advise</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group" >
                        <div class="row">
                            <div class="col-md-3">
                                <b><?php echo "Treatment Advise";?></b></div>
                            <div class="col-md-4">
                                <select name="treat" class="form-control consultant_id " >

                                    <?php
                                    foreach ($treatment_Advised as $new) {
                                        $sel = "";

                                        echo '<option  id="' . $new->Color . '" value="' . $new->name . '" >' . $new->name . '</option>';
                                    }
                                    ?>
                                </select>
                            </div>
                    ...
                    <div class="form-group input_fields_wrap2 quantity">
                        <div class="form-group" style="margin-top:20px;">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                <input type="text" class="form-control est_qty" name="quantity">
                    ...
                    <div class="form-group input_fields_wrap2 quantity">
                        <div class="form-group" style="margin-top:20px;">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                <input type="text" class="form-control est_rate" >
                    ...
                    <div class="form-group input_fields_wrap2 consultation_charge">
                        <div class="form-group" style="margin-top:20px;">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                <input type="text" class="form-control est_cost" name="consultation_charge">
...
<div class="modal fade" id="edit_inv2" tabindex="-1" role="dialog" aria-labelledby="addlabel" aria-hidden="true">
    <div class="modal-dialog dd">
        <div class="modal-content ff">
            <div class="modal-header">

                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="addlabel"><?php echo lang('edit'); ?> <?php echo 'Treatment Plan'; ?></h4>
            </div>
            <div class="modal-body">
                <div id="err_inv">
                    <?php
...
<div class="modal fade" id="edit_treatment_plan" tabindex="-1" role="dialog" aria-labelledby="addlabel" aria-hidden="true">
    <div class="modal-dialog dd">
        <div class="modal-content ff">
            <div class="modal-header">

                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="addlabel"> <?php echo 'Edit Treatment Plan'; ?></h4>
            </div>
            <div class="modal-body" id="editData">
                <img id="loading" src="<?php echo base_url('assets/img/green-ajax-loader.gif') ?>">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo lang('close') ?></button>
            </div>
...
<script>
    $(document).ready(function(){
    $('.est_rate').keyup(calculate);
    $('.est_qty').keyup(calculate);
});
function calculate(e)
{
    $('.est_cost').val($('.est_rate').val() * $('.est_qty').val());
}
</script>

<script>

    function payment_made_inv(e) {

        var valpay = e.value;
        if (valpay == 3) {
            $(e).parents('.form-group').eq(0).find('.payment_mode').html('<div class="col-md-2"><input type="text" name="cardno" value="" id="cardno"  placeholder="Card No" class="form-control cardno" /></div>');
        }

        if (valpay == 2) {
            $(e).parents('.form-group').eq(0).find('.payment_mode').html('<div class="col-md-2"><input type="text" name="bankname" value="" id="bankname" placeholder="Bank Name" class="form-control bankname" /></div><div class="col-md-2"><input type="text" name="chequeno" value="" id="chequeno"  placeholder="Cheque No" class="form-control chequeno" /></div></div>');
        }
        if (valpay == 4) {
            $(e).parents('.form-group').eq(0).find('.payment_mode').html('<div class="col-md-2 col-md-offset-6 "><select name="payment" class="form-control"  ><option value="paytm">Paytm </option><option value="mobikwik">Mobikwik</option><option value="netbanking">Netbanking</option></select></div>');
        }
        if (valpay == 1) {
            $(e).parents('.form-group').eq(0).find('.payment_mode').html('');
        }
    ...
    $("#add_teeth").submit(function (event) {
        ...
        if(teeth_row == 0){
            ...
            $("#qty1_"+teeth_row).val(size);
            $("#tooth"+teeth_row).val(teeth);
            $("#teeth"+teeth_row).val(teeth);
        }
        for (i = 0; i < size; i++) {
...
<?php if (isset($fees_all)): ?>
    ...
    $invoice_detail = $this->invoice_model->get_detail_latest_invoice($id);
                ...
                <div class="modal-body">
                    ...
                    <section class="content invoice" id="print_in_all">
                                ...
                                <td>    <div class="row">
                                    ...
                                    <table width="100%" border="0" style="border-bottom:1px solid #333; padding-bottom:30px;margin-bottom:10px">
                                        <tr>
                                            ...
                                            <td style="float:right"><b>OPD No.:</b> <?php echo $patient->username; ?></td>
                                        </tr>
                                        <tr>
                                            <td><b>Age:</b> <?php
                                                $year = $patient->dob;
                                                ...
                                                echo $age;
                                                ?></td>
                                            <!--<td style="float:right" class="invDateFromJquery"></td>-->
                                          	<td style="float:right"></td>
                                        </tr>
                                        <tr>
                                            <td><b>Sex:</b> <?php echo $patient->gender; ?></td>
                                            <td style="float:right"><!--<b>Date of Discharge:</b>
											<?php //echo date('d/m/Y', strtotime($latest->date_time)); ?>-->
                                            <b>Bill No. #<?php echo $id; ?></b><br />
                                            <b>Issue Date:</b> <?php echo date('d/m/Y') ?><br />
                                            </td>
                                            <!--<td style="float:right" class="invNumber"><b> Invoice </b> <?php echo $invoice_detail->invoice; ?></td>-->
                                        </tr>
                                        <tr>
                            ...
                            <tr>
                                <td>
                                    <table  width="100%" style="border:1px solid #CCCCCC;" >
                                        <tr>
                                            <td class='invoice_check' style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC" align="left" width="5%" ><b>Select Invoice</b></td>
                                            <td style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC" align="left" width="5%"><b># S.no</b></td>
                                        ...
                                        foreach ($fees_all as $inv) {
                                            ...
                                            if ($det->treatment_Advised_id != ''):
                                                ?>
                                                <tr style="border-top: 0.1px dotted #CCCCCC;" id="<?php echo $inv->id; ?>" >
                                                    <td class='invoice_check' width="5%" style="border-bottom:1px solid #CCCCCC;border-right:1px solid #CCCCCC;text-align:center" ><input class="invoice_select" type="checkbox" value="<?php echo $inv->id; ?>" /></td>
                                                    <td width="5%" style="border-right:1px solid #CCCCCC" class="hidden" ><?php echo $det->dates ?></td>
                                                    <td width="5%" style="border-right:1px solid #CCCCCC" class="hidden" ><?php echo $det->invoice ?></td>
                                                    <td width="5%" style="border-right:1px solid #CCCCCC" ><?php echo $j ?></td>
                                                    <td width="30%" style="border-right:1px solid #CCCCCC;padding-bottom: 5px;word-wrap: break-word;"><?php echo $string = preg_replace('/[^A-Za-z0-9\-\s]/', '', $det->treatment_Advised_id); ?>
                                                    </td>
                                                    <td style="border-right:1px solid #CCCCCC" width="25%"><?php
                                                        $array = $det->teeth;
                                                    ...
                                                    <td style="border-right:1px solid #CCCCCC" width="15%"><?php echo $det->rate; ?></td>									 <td width="15%" >&#8377;<?php
                                                        echo $det->amount;
                                        ...
                                        ?>
                                        <tr>
                                            <td  class='invoice_check' width="5%" style="border-bottom:1px solid #CCCCCC;border-right:1px solid #CCCCCC;text-align:center" ><input class="invoice_select_all" name="invoice" type="checkbox" /></td>
                                            ...
                                            <td style="border-bottom:1px solid #CCCCCC; border-top:1px solid #CCCCCC;"  width="15%" id="totalamount"><b>&#8377;<?php echo $tot_amt; ?></b></td>
                                        </tr>
                                        <?php if (isset($discountamt)): ?>
                                            <tr>
                                                <td class='invoice_check' width="5%" style="border-bottom:1px solid #CCCCCC;border-right:1px solid #CCCCCC;text-align:center" ></td>
                                                <td style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC;"  width="5%" align="left"><b></b></td>
                                                <td width="30%" style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC;">Discount</td>
                                                <td style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC;"  width="25%" align="left"></td>
                                                <td style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC;"  width="10%" align="left"></td>
                                                <td style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC;"  width="15%" align="left"></td>
                                                <td style="border-bottom:1px solid #CCCCCC; border-top:1px solid #CCCCCC;"  width="15%" id="discamount"><b>&#8377;<?php echo $discountamt; ?></b></td>
                                            </tr>
                                            <tr>
                                                <td class='invoice_check' style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC;"  width="5%" align="left"><b></b></td>
                                                <td style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC;"  width="5%" align="left"><b></b></td>
                                                ...
                                                <td style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC;"  width="10%" align="left"></td>
                                                <td style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC;"  width="15%" align="left"></td>
                                                <td style="border-bottom:1px solid #CCCCCC; border-top:1px solid #CCCCCC;"  width="15%" id="finalamount"><b>&#8377;<?php echo $tot_amt - $discountamt; ?></b></td>
                                            </tr>
                                        <?php endif; ?>
                                        <div class="row">
                                           <div class="col-md-12 ">
                                                Received with thanks, amount of &#8377;<span id="paymentInfo"><?php echo $tot_amt - $discountamt; ?></span> towards the following:
                                            </div>
                                        </div>
                                    </table>
                        ...
                        <table width="100%" style="border:1px solid #333;">
                            <tr>
                                <td class='invoice_check' style="border-bottom:1px solid #333; border-right:1px solid #333;" width="5%"><b>Select Payment.</b></td>
                            ...
                            foreach ($fees_all as $inv) {
                                ...
                                if (($det->treatment_Advised_id != '' && $det->credit!=0)||($det->debit==0&&$det->credit!=0)) {
                                    ?>
                                    <td class='invoice_check' style="border-bottom:1px solid #333;border-right:1px solid #333;text-align:center" ><input class="payment_select" type="checkbox" value="<?php echo $newId; ?>"  /></td>
                                    ...
                                    <td style="border-bottom:1px solid #333;">&#8377;<?php
                                        echo $det->credit;
                                        $payment += $det->credit;
                                        ?></td>
                                    <?php
                            ...
                            <tr>
                                <td class='invoice_check' style="border-bottom:1px solid #333;border-right:1px solid #333;text-align:center" ><input class="payment_select_all" type="checkbox" /></td>
                                <td style="border-right:1px solid #333;"></td>
                                <td style="border-right:1px solid #333;"></td>
                                <td style="border-right:1px solid #333;"><b>Total Payment</b></td>
                                <td style="" id="totalamountpay" ><b>&#8377;<?php echo $payment; ?></b></td>
                            </tr>
                        </table>
                        <br>
                        <!--<?php
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" style="text-align:right">
                                <br/>
                                <img src="<?php echo base_url();?>assets/uploads/images/<?php echo $setting->image1?>" height="80" width="120"></br>
                    ...
                    <?php
$data8['id']=$id;
$data8['name']=$details->patient;
$data8['contact']=$details->contact;
                    ...
                    if ($admin['user_role'] == 2) {
                        ...
                        <div class="row no-print" style="padding-top:20px;">
                            <div class="col-xs-12">
                                ...
                                <a href="<?php echo site_url('admin/invoice/pdf_all/' . $id) ?>"class="btn btn-primary pull-right" style="display:none;margin-right: 5px;"><i class="fa fa-download"></i> <?php echo lang('generate_pdf') ?></a>
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?php echo site_url('admin/payment/message/' . $id . '/' . $tot_amt.'/'.$payment)?>" class="btn btn-info" role="button">Message the Invoice</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Modal 2 -->
     <div class="modal fade" id="invoiceall1" tabindex="-1" role="dialog" aria-labelledby="invoicelabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content ff" style="width: 876px;">
                <div class="modal-header">

                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="invoicelabel">Treatment Estimate</h4>
                </div>
                <div class="modal-body">

                    <section class="content invoice" id="print_in_all1">
                        ...
                        <table width="100%" border="0"   class="bd" >
                            ...
                            <tr>
                                <td>
                                    <table  width="100%" style="border:1px solid #CCCCCC;" >
                                        <tr>
                                            <td class='invoice_check1' style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC" align="left" width="5%" ><b>Select Invoice</b></td>
                                            <td style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC" align="left" width="5%"><b>#S.no</b></td>
                                            <td style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC" align="left" width="30%"><b>Treatment Advised</b></td>
                                            <td style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC" align="left" width="25%"><b>Tooth No.</b></td>
                                            <td style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC" align="left" width="10%"><b>Quantity.</b></td>
                                            <td style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC" align="left" width="15%"><b>Rate</b></td>
                                            <td style="border-bottom:1px solid #CCCCCC;"  width="15%"><b>Estimation Cost</b></td>
                                        </tr>
                                        <?php
                                        $j = 1;
                                        $tot_amt = 0;
                                        foreach ($tooth_list as $inv) {
                                           // $det = $this->invoice_model->get_detail_new($inv->id);
                                            $tring = preg_replace('/[^A-Za-z0-9\-]/', '', $inv->treatment_Advised_id);
                                            
                                            if ($inv->treatment_Advised_id != ''):
                                                ?>
                                                <tr style="border-top: 0.1px dotted #CCCCCC;" id="<?php echo $inv->id; ?>" >
                                                    <td class='invoice_check1' width="5%" style="border-bottom:1px solid #CCCCCC;border-right:1px solid #CCCCCC;text-align:center" >
                                                        <input class="invoice_select1" type="checkbox" value="<?php echo $inv->id; ?>" /></td>
                                                    
                                                    <td width="5%" style="border-right:1px solid #CCCCCC" ><?php echo $j ?></td>
                                                    <td width="30%" style="border-right:1px solid #CCCCCC;padding-bottom: 5px;word-wrap: break-word;">
                                                        <?php echo $string = preg_replace('/[^A-Za-z0-9\-\s]/', '', $inv->treatment_Advised_id); ?>
                                                    </td>
                                                    <td style="border-right:1px solid #CCCCCC" width="25%"><?php
                                                        
                                                    $th = json_decode($inv->tooth);
                                                            print_r($th[0]);
                                                        
                                                        
                                                        ?></td>
                                                    <td style="border-right:1px solid #CCCCCC" width="10%"><?php echo $inv->quantity; ?></td>
                                                    <td style="border-right:1px solid #CCCCCC" width="15%">
													<?php 
													//echo $inv->estimate;
													echo ($inv->estimate/$inv->quantity) ;
													?>
                                                    </td>									 
                                                    <td width="15%" >&#8377;<?php
                                                        echo $inv->estimate;
                                                        $tot_amt = $tot_amt + $inv->estimate;
                                                        ?>
                                                    </td>
                                                </tr>
                                                <?php
                                        ...
                                        <tr>
                                            <td  class='invoice_check1' width="5%" style="border-bottom:1px solid #CCCCCC;border-right:1px solid #CCCCCC;text-align:center" >
                                                <input class="invoice_select_all1" name="invoice" type="checkbox" /></td>
                                            <td style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC;"  width="5%" align="left"><b></b></td>
                                            <td width="30%" style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC;"><b>Total Amount</b></td>
                                            <td style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC;"  width="25%" align="left"></td>
                                            <td style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC;"  width="10%" align="left"></td>
                                            <td style="border-bottom:1px solid #CCCCCC; border-right:1px solid #CCCCCC; border-top:1px solid #CCCCCC;"  width="15%" align="left"></td>
                                            <td style="border-bottom:1px solid #CCCCCC; border-top:1px solid #CCCCCC;"  width="15%" id="totalamount1"><b>&#8377;<?php echo $tot_amt; ?></b></td>
                                        </tr>
...
$data8['contact']=$details->contact;
                    ...
                    if ($admin['user_role'] == 2) {
                        ...
                        <div class="row no-print" style="padding-top:20px;">
                            <div class="col-xs-12">
                                <button class="btn btn-default" onclick="printDataAll1()"><i class="fa fa-print"></i> <?php echo lang('print') ?></button>
    ...
    <script>
        (function () {
            $(document).ready(function () {
                ...
                //****************invoice selection code ***************//
                function invoice_total() {
                    var row_ids = $('.invoice_select:checked').map(function () {
                        return $(this).val();
                    }).toArray();
                    var new_total = 0;
                    var dateArr =[];
                    ...
                    for (x in row_ids) {
						console.log('X => '+x);
                        // alert(x + "  -  " + row_ids[x] + "  -  " + parseInt($('#' + row_ids[x] + ' td').last().text().replace('₹', '')));
						var amt = parseInt($('#' + row_ids[x] + ' td').last().text().replace('₹', ''));
						console.log(amt);
                        new_total += amt;
                        var  date = $('#' + row_ids[x] + ' td')[1].innerText;
                        dateArr.push(new Date(date));
                        var invoice = $('#' + row_ids[x] + ' td')[2].innerText;
                        invArr.push(invoice);
                    }
               		console.log('new_total =>'+ new_total);
					
                    if(dateArr.length > 0){
                      $('.invDateFromJquery').text("Date : "+ new Date(dateArr[0]).toLocaleDateString('en-GB')) 
                      $('.invNumber').text("Invoice : "+ invArr[0])
                      
                    }else{
                          $('.invDateFromJquery').text("Date : ") 
                      $('.invNumber').text("Invoice : ")
                    }
                    
                    
                    
                    // console.log(dateArr)
                    $('#totalamount').html('<b>&#8377;' + new_total + '</b>');
                    if ($('#discamount').length > 0)
                        var discount = parseInt($('#discamount').text().replace('₹', ''));
                    else
                        var discount = 0;

                    $('#finalamount').html('<b>&#8377;' + (new_total - discount) + '</b>');

                }

                $('.invoice_select_all').on('ifChecked', function (event) {
                    $('.invoice_select').iCheck('check');
                    $('.invoice_select').iCheck('update');
                    invoice_total();
                });

                $('.invoice_select_all').on('ifUnchecked', function (event) {
                    $('.invoice_select').iCheck('uncheck');
                    $('.invoice_select').iCheck('update');
                    invoice_total();
                });

                $('.invoice_select').on('ifChecked', function (event) {
                    $(event.target).iCheck('check');
                    $(event.target).iCheck('update');
                    var count = $('.invoice_select').length;
                    var count_checked = $('.invoice_select:checked').length
                    if (count == count_checked) {
                        $('.invoice_select_all').iCheck('check');
                        $('.invoice_select_all').iCheck('update');
                    }
                    invoice_total();

                });

                $('.invoice_select').on('ifUnchecked', function (event) {
                    $(event.target).iCheck('uncheck');
                    $(event.target).iCheck('update');
                    $('.invoice_select_all').iCheck('uncheck');
                    $('.invoice_select_all').iCheck('update');
                    invoice_total();
                });
...
////////******************************selection model2******************//////////////
 function invoice_total1() {
                    var row_ids = $('.invoice_select1:checked').map(function () {
                        return $(this).val();
                    }).toArray();
                    var new_total = 0;
                    var dateArr =[];
                    ...
                    for (x in row_ids) {
                        // alert(x + "  -  " + row_ids[x] + "  -  " + parseInt($('#' + row_ids[x] + ' td').last().text().replace('₹', '')));
                        new_total += parseInt($('#' + row_ids[x] + ' td').last().text().replace('₹', ''));
                        var  date = $('#' + row_ids[x] + ' td')[1].innerText;
                        dateArr.push(new Date(date));
                        var invoice = $('#' + row_ids[x] + ' td')[2].innerText;
                        invArr.push(invoice);
                ...
                $('.invoice_select_all1').on('ifChecked', function (event) {
                    $('.invoice_select1').iCheck('check');
                    $('.invoice_select1').iCheck('update');
                    invoice_total1();
                });

                $('.invoice_select_all1').on('ifUnchecked', function (event) {
                    $('.invoice_select1').iCheck('uncheck');
                    $('.invoice_select1').iCheck('update');
                    invoice_total1();
                });

                $('.invoice_select1').on('ifChecked', function (event) {
                    $(event.target).iCheck('check');
                    $(event.target).iCheck('update');
                    var count = $('.invoice_select1').length;
                    var count_checked = $('.invoice_select1:checked').length
                    if (count == count_checked) {
                        $('.invoice_select_all1').iCheck('check');
                        $('.invoice_select_all1').iCheck('update');
                    }
                    invoice_total1();

                });

                $('.invoice_select1').on('ifUnchecked', function (event) {
                    $(event.target).iCheck('uncheck');
                    $(event.target).iCheck('update');
                    $('.invoice_select_all1').iCheck('uncheck');
                    $('.invoice_select_all1').iCheck('update');
                    invoice_total1();
                });
                ...
                //**********payments selection code**************//
                function payment_total() {
                    var row_ids = $('.payment_select:checked').map(function () {
                        return $(this).val();
                    }).toArray();
                    var new_total = 0;
                    ...
                    $('#paymentInfo').html(new_total);
                    $('#totalamountpay').html('<b>&#8377;' + new_total + '</b>');
                   
                }

                $('.payment_select_all').on('ifChecked', function (event) {
                    $('.payment_select').iCheck('check');
                    $('.payment_select').iCheck('update');
                    payment_total();
                });

                $('.payment_select_all').on('ifUnchecked', function (event) {
                    $('.payment_select').iCheck('uncheck');
                    $('.payment_select').iCheck('update');
                    payment_total();
                });

                $('.payment_select').on('ifChecked', function (event) {
                    $(event.target).iCheck('check');
                    $(event.target).iCheck('update');
                    var count = $('.payment_select').length;
                    var count_checked = $('.payment_select:checked').length
                    if (count == count_checked) {
                        $('.payment_select_all').iCheck('check');
                        $('.payment_select_all').iCheck('update');
                    }
                    payment_total();

                });

                $('.payment_select').on('ifUnchecked', function (event) {
                    $(event.target).iCheck('uncheck');
                    $(event.target).iCheck('update');
                    $('.payment_select_all').iCheck('uncheck');
                    $('.payment_select_all').iCheck('update');
                    payment_total();
                });
        ...
        function printDataAll()
        {
            ...
            if ($('.invoice_select_all:checked').length > 0) {

            } else {
                var row_ids = $(".invoice_select:not(:checked)").map(function () {
                    return $(this).val();
                }).toArray();
                for (x in row_ids) {
                    $('#' + row_ids[x]).hide();
            ...
            if ($('.payment_select_all:checked').length > 0) {

            } else {
                var row_ids = $(".payment_select:not(:checked)").map(function () {
                    return $(this).val();
                }).toArray();
                for (x in row_ids) {
                    $('#' + row_ids[x]).hide();
        ...
        function printDataAll1()
        {
            
            if ($('.invoice_select_all1:checked').length > 0) {

            } else {
                var row_ids = $(".invoice_select1:not(:checked)").map(function () {
                    return $(this).val();
                }).toArray();
                for (x in row_ids) {
                    $('#' + row_ids[x]).hide();
            ...
            var divToPrint = document.getElementById("print_in_all1");
            newWin = window.open("");
            newWin.document.write(divToPrint.outerHTML);
            newWin.print();
            newWin.close();
...
" width="100%" />';
                                        ...
                                        <table  width="100%" style="border:1px solid #CCCCCC;" >
                                            ...
                                            <tr >
                                                <td style="border-right:1px solid #CCCCCC"
                                                    width="5%">1</td>
                                                <td style="border-right:1px solid #CCCCCC" width="30%"><?php echo $string = preg_replace('/[^A-Za-z0-9\-\s]/', '', $details->treatment_Advised_id); ?></td>
                                                <td style="border-right:1px solid #CCCCCC" width="25%"><?php
                                                    $array = json_decode($details->teeth);
                                                    for ($i = 0; $i < sizeof($array); $i++) {
                                                        echo $array[$i];
                                                    }
                                                    ?></td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6" style="text-align:right">
                                    \ <br/> <img src="<?php echo base_url();?>assets/uploads/images/<?php echo $setting->image1?>" height="80" width="120"></br>
                                     <?php echo $setting->name;?>
                                </div>
                            </div>
                        </section>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body"  >
                    <table width="100%" border="0" id="printTable<?php echo $prescription->id ?>"  class="pt" style="padding-bottom:0px; height:100%;page-break-after: always; page-break-inside: avoid;" >
                        ...
                        <tr>
                            <td >
                                <table width="100%" style="background-color: #E3E3E6;">
                                    <tbody>
                                    <tr>
                                        <td >
                                            <table width="100%" style="border-bottom:1px solid black">
                                                <tr>
                                                    <td><b>Patient <?php echo lang('name') ?></b> : <?php echo substr($patient->name, 0, 20) ?></td>
                                                    <td style="text-align:right"><b>Date</b> : <?php echo date('d/m/Y', strtotime($prescription->date_time)) ?></td>
                                                </tr>
                                                <tr>
                                                    <td ><b>Patient <?php echo lang('id') ?></b> : <?php echo $patient->id ?></td>
                                                    <td style="text-align:right"><b><?php echo lang('age') ?></b> : <?php echo date("Y") - $patient->dob ?> Years</td>
                                ...
                                <table width="100%" border="0">
                                    <tr>
                                        <td width="70%" valign="top">
                                                ...
                                                <tr>
                                                    <td width="100%">
                                                        ...
                                                        <?php if ($prescription->chiff_Complaint_id != '""' || $prescription->chiff_Complaint_history != '') { ?><table border="0">
                                                            ...
                                                            <?php
                                                            $d = json_decode($prescription->chiff_Complaint_id);
                                                ...
                                                <?php //###########################################################Chiff Complaint#################################################################################   ?>                                         <tr>
                                                    <td>
                                                        <?php if ($prescription->medical_History_id != '""' || $prescription->medical_History_history != '') { ?><table border="0" >
                                                            ...
                                                            <?php
                                                            $c = json_decode($prescription->medical_History_id);
                                                ...
                                                <?php //#########################################################durg allergy###################################################################################   ?>                                         <tr>
                                                    <td>
                                                        <?php if ($prescription->drug_Allergy_id != '""' || $prescription->drug_Allergy_history != '') { ?><table border="0">
                                                            ...
                                                            <?php
                                                            $d = json_decode($prescription->drug_Allergy_id);
                                                ...
                                                <?php //##########################################################Extra oral exm##################################################################################   ?>                                         <tr>
                                                    <td>
                                                        <?php if ($prescription->extra_Oral_Exm_id != '""' || $prescription->extra_Oral_Exm_history != '') { ?><table border="0">
                                                            ...
                                                            <?php
                                                            $d = json_decode($prescription->extra_Oral_Exm_id);
                                                ...
                                                <?php //#############################################################inter oral Exm###############################################################################    ?>                                         <tr>
                                                    <td>
                                                        <?php if ($prescription->intra_Oral_Exm_id != '[""]') { ?><table border="0">
                                                            ...
                                                            <?php
                                                            $d = json_decode($prescription->intra_Oral_Exm_id);
                                                        ...
                                                        <?php if ($prescription->treatment_Advised_id != '[""]') { ?> <table border="0">
                                                            ...
                                                            <tr>
                                                                <td><?php
																	...
																	//echo '<pre>$ins1: '; print_r($ins1); echo '</pre>';
                                                                    if (is_array($d)) {
                                                                        $i = 1;
                                                                        foreach ($d as $key => $new) {
																			if($new != ''){
																				...
																				if (!empty($ins1[$key][0]))
																				echo '<tr><td><p style="padding-left:32px;"><small>' . @$ins1[$key][0] . '</small></p><td></tr>';
																				$i++;
																			}
                                                                        }
                                                                    }else {
                                            ...
                                            <table border="0" width="100%" style="background-color: #E3E3E6;" >
                                                <tr>
                                                    <td><b><p><span style="font-size:26px">R</span><sub style="font-size:18px">x</sub></p></b></td>
                                                </tr>
                                                <?php
                                                $d = json_decode($prescription->medicines);
                                                $ins = json_decode($prescription->medicine_instruction);
                                                $frequency = json_decode($prescription->frequency);
                                                $duration = json_decode($prescription->duration); ?>
 <tr><td><p style="padding-left:32px;">  <b>Medicine</b> </p></td>
                                                    <td><p style="padding-left:32px;"> <b>Timing</b> </p></td>
                                                     <td><p style="padding-left:32px;"><b>Frequency</b> </p></td>
                                                    <td><p style="padding-left:32px;"> <b>Duration</b> </p></td></tr> <?php 
                                                if (is_array($d)) {
                                                    $i = 1;
                                                    foreach ($d as $key => $new) {
                                                        if (!empty($d[$key])) {
                                                           echo '<tr><td><p style="padding-left:32px;">' . $d[$key].'</p></td>';
                                                            echo '<td><p style="padding-left:32px;">' . @$ins[$key] . '</p></td>';
                                                            echo '<td><p style="padding-left:32px;">' . @$frequency[$key] . '</p></td>';
															$durationDays = @$duration[$key];
															$checkDay = strpos($durationDays, '(s)');
															if ($checkDay === false) {
																$durationDays .= ' day';
															}
                                                            echo '<td><p style="padding-left:32px;">' . $durationDays . '</p></td></tr>';
                                                        }
                                                        $i++;
                                                    }
                                                } else {
  ...
  <!--<tr><td><img src="http://doctori8.com/doctor/assets/img/frame.png" height='120'></td></tr>-->
                        </tbody>
        ...
        <script>
		function printData(prescription_id)
		{
			var divToPrint = document.getElementById("printTable"+prescription_id);
			document.getElementById("print_p").style.display = 'none';
			newWin = window.open("");
			newWin.document.write(divToPrint.outerHTML);
			if ($("#extraction").prop("checked") == true) {
				newWin.document.write('<div style="page-break-before:always"><table width="100%" style="border-bottom:1px solid;"><tr><td style="line-height:110%"><?php
					if (strpos($template->header, 'http://') === false && strpos($template->header, 'https://') === false) {
						echo $template->header;
					} else {
						echo '<img src="' . $template->header . '" width="100%" height="auto" />';
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    $y = date('Y');
                                    echo $y - $patient->dob;
                                    ?>" class="form-control dob" style="width:90px">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label for="insurance" style="clear:both"><?php echo lang('group'); ?></label>
                                    <input type="text" name="group" class="form-control"
                                           value="<?php echo $patient->group; ?>"/>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" action="<?php echo site_url('admin/prescription/edit/' . $new->id . '/' . $patient->id) ?>" enctype="multipart/form-data" id="edit_form">
                                                ...
                                                <select name="chiff_Complaint_id[]" class="form-control chzn" multiple="multiple" data-placeholder="Select an option">
                                                    ...
                                                    foreach ($chiff_Complaints as $new) {
                                                        ...
                                                        foreach ($chief_complaint as $n) {
                                                            if ($n === $new->name) {
                                                                $sel = set_select('chiff_Complaint_id', $new->name, TRUE);
                                                                break;
                                                            } else {
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <select name="medical_History_id[]" class="form-control chzn" multiple="multiple" data-placeholder="Select an option">
                                                    ...
                                                    foreach ($medical_History as $new) {
                                                        ...
                                                        foreach ($med as $n) {
                                                            if ($n === $new->name) {
                                                                $sel = set_select('medical_History_id', $new->name, TRUE);
                                                                break;
                                                            } else {
                                                                $sel = set_select('chiff_Complaint_id', $new->name, FALSE);
                                                            }
                                                ...
                                                <select name="drug_Allergy_id[]" class="form-control chzn" multiple="multiple" data-placeholder="Select an option">
                                                    ...
                                                    foreach ($drug_Allergy as $new) {
                                                        ...
                                                        foreach ($drug_all as $n) {
                                                            if ($n === $new->name) {
                                                                $sel = set_select('drug_Allergy_id', $new->name, TRUE);
                                                                break;
                                                            } else {
                                    ...
                                    <div class="col-md-4">
                                        <select name="extra_Oral_Exm_id[]" class="form-control chzn disease_id" multiple="multiple">
                                            ...
                                            foreach ($extra_Oral_Exm as $new) {
                                                ...
                                                foreach ($eox as $n) {
                                                    if ($n === $new->name) {
                                                        $sel = set_select('extra_Oral_Exm_id', $new->name, TRUE);
                                                        break;
                                                    } else {
                                                    ...
                                                    <div class="col-md-8">
                                                        <select name="intra_Oral_Exm_1" class="form-control chzn" multiple="multiple">
                                                            ...
                                                            foreach ($treatment_Advised_ins as $new) {
                                                                $sel = "";
                                                                if (set_select('test_instruction', $new->name))
                                                                    $sel = "selected='selected'";
                                                                echo '<option value="' . $new->name . '" ' . $sel . '>' . $new->name . '</option>';
                                                            }
                                                            ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12 iox-append">
                                        <div class="row">
                                            ...
                                            <?php
                                            $intra_c = 1;
                                            $iox = json_decode($prescription->intra_Oral_Exm_id);
                                            ...
                                            foreach ($iox as $io) {
                                                ...
                                                <div class="row"><?php
                                                    if ($intra_c > 1) {
                                                        echo "<div class='col-md-2' style='width:17.5%'></div>";
                                                    }
                                                    ?>					<div class="col-md-3">
                            ...
                            <?php
							$treatment_Advised_id = json_decode($prescription->treatment_Advised_id);
							$treatment_Advised_instruction = json_decode($prescription->treatment_Advised_instruction);
							
							if(!empty($treatment_Advised_id))
							{
								foreach($treatment_Advised_id as $key => $treatAd)
								{
									$advId = $key+1;
							?>
                                ...
                                <div class="row  ">
                                    ...
                                    <div class="col-md-4" >
                                        <div>
                                            <select name="treatment_Advised_id_<?php echo $advId;?>" class="form-control chzn " >
                                                <option value="">--<?php echo lang('treatment_advised'); ?>--</option>
                                    ...
                                    <div class="col-md-4">
                                        <select name="treatment_Advised_instruction_<?php echo $advId;?>" class="form-control chzn add-treatment_advised_instruction" multiple="multiple">
                                            <option value="">--<?php echo lang('treatment_Advised_instruction'); ?>--</option>
                                            <?php
                                            foreach ($treatment_Advised_ins as $new) {
                                                $sel = "";
                                                //if (set_select('test_instruction', $new->name))
												if($new->name == $treatment_Advised_instruction[$key])
                                                    $sel = "selected='selected'";
                                                echo '<option value="' . $new->name . '" ' . $sel . '>' . $new->name . '</option>';
                                            }
                                            ?>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-offset-2" style="padding-left:12px;">
                                        <button class="add_field_button4 btn btn-success"><?php echo lang('add'); ?> </button>
                                        <input type="hidden" name="edit_advice_tot" id="edit_advice_tot" value="<?php echo $advId;?>" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <label for="name" style="clear:both;">ADD Medicine Template</label>
                                            </div>
                                            <div class="col-md-8">
        
                                                <select name="medicine_template_id_edit[]" class="form-control chzn" multiple="multiple" data-placeholder="Select an option" id="edit-medicine_template_id">
                                                    <?php
													$medicine_template_id = json_decode($prescription->medicine_template_id);
                                                    foreach ($medicine_template as $new) {
                                                        $sel = "";
														if(in_array($new->id,$medicine_template_id))
															$sel = " selected='selected' ";
                                                        //$sel = set_select('medicine_template_id', $new->name, FALSE);
                                                        echo '<option value="' . $new->id . '" ' . $sel . '>' . $new->name . '</option>';
                                                    }
                                                    ?>
                                                </select>
                            ...
                            $frequnecy = json_decode($prescription->frequnecy);
                            $duration = json_decode($prescription->duration);
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2" >
                                                ...
                                                <select name="medicine_id[]" class="form-control medicine_id" id="medicine_id"style="width:100%">
                                            ...
                                            <div class="col-md-2">
                                                <select name="instruction[]" class="form-control  instruction">
                                                    <option value="">--<?php echo $medi_ins1[@$key] ?>--</option>
                                                    <?php
                                                    foreach ($medicine_ins as $new) {
                                                        $sel = "";
                                                        if ($new->name == $medi_ins1[$key])
                                                            $sel = "selected='selected'";
                                                        echo '<option value="' . $new->name . '" ' . $sel . '>' . $new->name . '</option>';
                                                    }
                                                    ?>
                                            ...
                                            <div class="col-md-2">
                                                <select name="frequency[]" class="form-control ">
                                                    ...
                                                    <option value="Every Hour"  <?php echo ($frequency[@$key] == "Every Hour") ? 'selected' : ''; ?>>Every Hour</option>
                                                    <option value="Every other day" <?php echo ($frequency[@$key] == "Every other day") ? 'selected' : ''; ?>>Every other day</option>
                                                    <option value="Twice a day" <?php echo ($frequency[@$key] == "Twice a day") ? 'selected' : ''; ?>>Twice a day</option>
                                                    <option value="Three times a day" <?php echo ($frequency[@$key] == "Three times a day") ? 'selected' : ''; ?>>Three times a day</option>
                                                    <option value="Four times a day" <?php echo ($frequency[@$key] == "Four times a day") ? 'selected' : ''; ?>>Four times a day</option>
                                                    <option value="At Night" <?php echo ($frequency[@$key] == "At Night") ? 'selected' : ''; ?>>At Night</option>
                                                    <option value="At Morning" <?php echo ($frequency[@$key] == "At Morning") ? 'selected' : ''; ?>>At Morning</option>
                                                    <option value="At Noon" <?php echo ($frequency[@$key] == "At Noon") ? 'selected' : ''; ?>>At Noon</option>
                                                </select>
                                            </div>
                                            <div class="col-md-1">
                                                <select name="duration1[]" class="form-control">
                                                    <?php for ($i = 1; $i <= 31; $i++) { ?>
                                                        <option value="<?php echo $i; ?>"  <?php echo (explode(' ', $duration[@$key])[0]) == $i ? 'selected' : ''; ?>><?php echo $i; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                            <div class="col-md-1 ">
                                                <select name="duration2[]" class="form-control ">
                                                    <option value="Day(s)" <?php echo (explode(' ', $duration[@$key])[1]) == "Day(s)" ? 'selected' : ''; ?>>Day(s)</option>
                                                    <option value="Month(s)" <?php echo (explode(' ', $duration[@$key])[1]) == "Month(s)" ? 'selected' : ''; ?>>Month(s)</option>
                                                    <option value="Year(s)" <?php echo (explode(' ', $duration[@$key])[1]) == "Year(s)" ? 'selected' : ''; ?>>Year(s)</option>
                                                </select>
                                            </div>

                                            <a href="#" class="remove_field btn btn-danger" onclick="$(
                                                                            this).parent('div').remove();"><?php echo lang('remove'); ?></a>
                                        ...
                                        <div class="row  ">
                                            ...
                                            <div class="col-md-4">
                                                <select name="test_instruction[]" class="form-control chzn test_instruction">
                                                    ...
                                                    <?php
                                                    foreach ($test_ins as $new) {
                                                        $sel = "";
                                                        if ($new->name == $tests_ins1[$key])
                                                            $sel = "selected='selected'";
                                                        echo '<option value="' . $new->name . '" ' . $sel . '>' . $new->name . '</option>';
                                                    }
                                                    ?>
                                            ...
                                            <div class="col-md-2">
                                                <a href="#" class="delete_activity btn btn-danger" style="margin-left: 25px;"><?php echo lang('remove'); ?></a>
                                            </div>
        ...
        <div class="modal-content " >
            ...
            <div class="modal-body ht" >
                <form method="post"	 id="add_prescription_form">
                    ...
                    <div class="form-group" style="display:none;">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="disease_id[]" class="form-control chzn disease_id" multiple="multiple" data-placeholder="Select O/E" id="disease_id">
                                    <?php
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <select name="medicine_template_id[]" class="form-control chzn" multiple="multiple" data-placeholder="Select an option" id="add-medicine_template_id">
                                            <?php
                                            foreach ($medicine_template as $new) {
                                                $sel = "";
                                                $sel = set_select('medicine_template_id', $new->name, FALSE);
                        ...
                        <?php if (empty($_POST['medicine_id'])) { ?>
                            <div class="form-group input_fields_wrap">
                                <div class="row  ">
                                    ...
                                    <div class="col-md-2" >
                                        <div>
                                            <select name="medicine_id[]" class="form-control  add-medicine_id chzn">
                                                <option value="">--<?php echo lang('select_medicine'); ?>--</option>
                                                <?php
                                                foreach ($medicines as $new) {
                                                    $sel = "";
                                    ...
                                    <div class="col-md-2 ">
                                        <select name="instruction[]" class="form-control add-instruction chzn">
                                    ...
                                    <div class="col-md-2">
                                        <select name="frequency[]" class="form-control chzn">
                                            <option value="">-- Frequency for Medicine --</option>
                                    ...
                                    <div class="col-md-1">
                                        <select name="duration1[]" class="form-control chzn">
                                    ...
                                    <div class="col-md-1 ">
                                        <select name="duration2[]" class="form-control chzn">
                        ...
                        <div class="form-group ">
                            <div class="row  ">
                                ...
                                <div class="col-md-6" >
                                    ...
                                    <?php
                                    $i = 1;
                                    foreach ($_POST['medicine_id'] as $key => $val) {
                                        ?>
                                ...
                                <div class="col-md-6">
                                    <?php
                                    $i = 1;
                                    foreach ($_POST['instruction'] as $key => $val) {
                                        ?>
                                        <div class="row delete<?php echo $i; ?>">
                                            <div class="col-md-8 " >
                                    ...
                                    <div class="col-md-3" >
                                        <div>
                                            <select name="report_id_1" class="form-control chzn add-report_id" id="add-report_id">
                                                ...
                                                foreach ($tests as $new) {
                                                    $sel = "";
                                                    if (set_select('report_id', $new->name))
                                                        $sel = "selected='selected'";
                                                    echo '<option value="' . $new->name . '" ' . $sel . '>' . $new->name . '</option>';
                                                }
                                                ?>
                        ...
                        <div class="form-group ">
                            <div class="row  ">
                                ...
                                <div class="col-md-6" >
                                    ...
                                    <?php
                                    $i = 1;
                                    foreach ($_POST['report_id'] as $key => $val) {
                                        ?>
                                ...
                                <div class="col-md-6">
                                    <?php
                                    $i = 1;
                                    foreach ($_POST['test_instruction'] as $key => $val) {
                                        ?>
                                        <div class="row delete_test<?php echo $i; ?>">
                                            <div class="col-md-8 " >
                                            ...
                                            <div class="col-md-4">
                                                <a  style="margin-left: 25px;" href="#test_div" class="btn btn-danger" onclick="$('.delete_test<?php echo $i; ?>').remove();"><?php echo lang('remove'); ?></a>
                                            </div>
                                        </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <input name="paid" value="1" id="pd" class="paid" style="position: absolute; opacity: 0;" type="checkbox"><label for="name" style="clear:both;"> &nbsp; &nbsp; Message </label>
                        </div>
                    </div>
...
<!--Modal for patient dashboard Notes -->
    ...
    <div class="modal-dialog modal-sm" style="width:600px">
        <div class="modal-content ff">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="addlabel"><span id="trtHeader"></span> : <span style="float: right;
    margin-right: 20px;"> <?php echo  date("Y-m-d");?></span> </h4>
            </div>
            <div class="modal-body">
                <div id="err">  
                    <?php
                ...
                <div>
                    <div class="box-body">
                    <input id="trtId" name="treatId" type="hidden" value="">
                        <div class="form-group">
                            <div class="row">
                                 <div class="col-md-6">
                                    <label for="NoteInput" style="clear:both;">Note : </label>
                                    <br/>
                                    <textarea id="treatNote" name="treatNote" maxlength="160" id="" cols="30" rows="10"></textarea>
                                </div> 
                            </div>
                        </div>
            <div class="modal-footer">
...
<div class="modal fade" id="add_PaymentNote" tabindex="-1" role="dialog" aria-labelledby="addlabel" aria-hidden="true">
    ...
    margin-right: 20px;"> <?php echo  date("Y-m-d");?></span> </h4>
            ...
            <div class="modal-body">
                ...
                <div>
                    <div class="box-body">
                    <input id="treatIdPaymentNote" name="treatIdPaymentNote" type="hidden" value="">
                        <div class="form-group">
                            <div class="row">
                                 <div class="col-md-6">
                                    <label for="NoteInput" style="clear:both;">Note : </label>
                                    <br/>
                                    <textarea id="txtPaymentNote" name="txtPaymentNote" maxlength="160" id="" cols="30" rows="10"></textarea>
                                </div> 
                            </div>
                        </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" id="btnSubmitPaymentNote" onclick="setColor('paymentAddNoteButton', '#101010')";>Submit</button>  
            </div>
        </div>
                    </div>
    </div>
...
<script type="text/javascript">
    ...
    $("#add_prescription_form").submit(function (event) {
        ...
        var length = $("#add_prescription select[name='medicine_id[]']").length
        for (x = 0; x < length; x++) {
            if ($("#add_prescription select[name='medicine_id[]']").length != 0) {
                var a = $("#add_prescription select[name='medicine_id[]']").eq(x).val();
                medicine_id.push(a);
            }
        }
        var medicine_instr = new Array();
        var length = $("#add_prescription select[name='instruction[]']").length
        for (x = 0; x < length; x++) {
            if ($("#add_prescription select[name='instruction[]']").length != 0) {
                var a = $("#add_prescription select[name='instruction[]']").eq(x).val();
                medicine_instr.push(a);
            }
        }

        var frequency = new Array();
        var length = $("#add_prescription select[name='frequency[]']").length;
        for (x = 0; x < length; x++) {
            if ($("#add_prescription select[name='frequency[]']").length != 0) {
                var a = $("#add_prescription select[name='frequency[]']").eq(x).val();
                frequency.push(a);
            }
        }
        var duration = new Array();
        var length = $("#add_prescription select[name='duration1[]']").length;
        for (x = 0; x < length; x++) {
            if ($("#add_prescription select[name='duration1[]']").length != 0 && $("#add_prescription  select[name='duration2[]']").length != 0) {
                var a = $("#add_prescription select[name='duration1[]']").eq(x).val() + ' ' + $("#add_prescription select[name='duration2[]']").eq(x).val();
                duration.push(a);
            }
        }
        ...
        var medicine_template_id = $("#add-medicine_template_id").val();
        ...
        var dat = {'prescription_id': id,'paid': paid, 'date_time': date_time, 'chiff_Complaint_id': chief_complaint_id, 'chiff_Complaint_history': chief_complaint_history, 'medical_History_id': medical_history_id, 'medical_History_history': medical_history_history, 'drug_Allergy_id': drug_allergy_id, 'medicine_template_id': medicine_template_id, 'drug_Allergy_history': drug_allergy_history, 'patient_id': patient_id, 'extra_Oral_Exm_id': extra_oral_exm_id, 'extra_Oral_Exm_history': extra_oral_exm_history, 'intra_Oral_Exm_id': intra_oral_exm_id, 'intra_Oral_Exm_history': intra_Oral_Exm_history, 'treatment_Advised_id': treatment_advised_id, 'treatment_Advised_instruction': treatment_advised_instr, 'medicine_id': medicine_id, 'instruction': medicine_instr, 'frequency': frequency, 'duration': duration, 'report_id': test_id, 'test_instruction': test_intr, 'remark': remark};
        console.log(dat);
        $.ajax({
...
<?php echo lang('select_medicine'); ?>--</option><?php
                    ...
                    ?></select></div>\n\
                                        ...
                                        <option value="31">31</option>\n\
                                                        ...
                                                        <div class="col-md-1 "><select name="duration2[]" class="form-control chzn"><option value="Day(s)">Day(s)</option><option value="Month(s)">Month(s)</option><option value="Year(s)">Year(s)</option></select></div><a href="javascript:{$(this).parent("div").remove();}" class="remove_field btn btn-danger"><?php echo lang('remove'); ?></a></div></div>'); //add input box
    ...
    $(document).ready(function () {
        ...
        $(add_button).click(function (e) { //on add input button click
            ...
            if (x < max_fields) { //max input box allowed
                ...
                x++; //text box increment
                $(wrapper).append('<div class="row"><div class="col-md-2"></div><div class="col-md-3"><select name="report_id_' + x + '" class="form-control chzn add-report_id"><option value="">--<?php echo lang('select_medical_test'); ?>--</option><?php
                    foreach ($tests as $new) {
                        echo '<option value="' . $new->name . '">' . $new->name . '</option>';
                    }
                    ?></select></div><div class="col-md-3"><select name="test_instruction_' + x + '" class="form-control chzn add-test_instruction"><option value="">--<?php echo lang('medical_test_instruction'); ?>--</option><?php
                    foreach ($test_ins as $new) {
                        echo '<option value="' . $new->name . '">' . $new->name . '</option>';
                    }
                    ?></select></div><a style="margin-left: 35px;" href="#" class="remove_field1 btn btn-danger"><?php echo lang('remove'); ?></a></div></div>'); //add input box
                $('.chzn').chosen({search_contains: true});
            }
        });
    ...
    $(document).ready(function () {
        ...
        $(add_button).click(function (e) { //on add input button click
            ...
            if (x < max_fields) { //max input box allowed
                x++; //text box increment
                $(wrapper).append('<div class="row"><div class="col-md-2"></div><div class="col-md-3"><select name="treatment_Advised_id_' + x + '" class="form-control chzn add-treatment_advised_id"><option value="">--<?php echo lang('Treatment_Advised'); ?>--</option><?php
                    foreach ($treatment_Advised_tests as $new) {
                        echo '<option value="' . $new->name . '">' . $new->name . '</option>';
                    }
                    ?></select></div><div class="col-md-4" style="padding-left: 120px;"><select name="treatment_Advised_instruction_' + x + '" class="form-control chzn add-treatment_advised_instruction" multiple="multiple"><option value="">--<?php echo lang('treatment_Advised_instruction'); ?>--</option><?php
                    foreach ($treatment_Advised_ins as $new) {
                        echo '<option value="' . $new->name . '">' . $new->name . '</option>';
                    }
                    ?></select></div><a href="#" class="remove_field1 btn btn-danger"><?php echo lang('remove'); ?></a></div></div>'); //add input box
                $('.chzn').chosen({search_contains: true});
            }
        });
	...
	$(document).ready(function () {
        ...
        var x = parseInt($("#edit_advice_tot").val()); //initlal text box count
		//var x = 1; //initlal text box count
    ...
    $(document).ready(function () {
        ...
        $(add_button).click(function (e) { //on add input button click
            ...
            if (x < max_fields) { //max input box allowed
                x++; //text box increment
                $(wrapper).append('<div class="row"><div class="col-md-2"></div><div class="col-md-3"><select name="intra_Oral_' + x + '" class="form-control chzn"><option value="">--<?php echo 'Select an option'; ?>--</option><?php
                    foreach ($intra_Oral_Exm as $new) {
                        echo '<option value="' . $new->name . '">' . $new->name . '</option>';
                    }
                    ?></select></div><div class="col-md-5" style="padding-left: 120px;"><select name="intra_Oral_Exm_' + x + '" class="form-control chzn" multiple="multiple" data-placeholder="Select an option"><?php
                    foreach ($treatment_Advised_ins as $new) {
                        echo '<option value="' . $new->name . '">' . $new->name . '</option>';
                    }
                    ?></select></div><a href="#" class="remove_field3 btn btn-danger"><?php echo lang('remove'); ?></a></div></div>'); //add input box
                $('.chzn').chosen({search_contains: true});
            }
        });
    ...
    /*$(document).ready(function(){
        ...
        var $ashu = $('#ashu');
        function onChange() {
            $ashu.val($ty.val()*$mt.val());
        };
        $('#amt1').change(onChange).keyup(onChange);
    });*/
	
	$(document).on("click",'#add_prescription_popup',function () {	
		console.log('Here NOw in add');
		$('#add_prescription').modal('show');
		$("#add-chiff_complaint_id").chosen();
		$("#add-medical_history_id").chosen();
		$("#add-drug_allergy_id").chosen();
		$("#add-extra_oral_exm_id").chosen();
		$("#add-medicine_template_id").chosen();
	});
	...
	$(document).on("keyup",'input[name="qty[]"]',function () {	
		...
		if(qty == '' || rate == '')
			...
			$("#qty_rate"+cnt).val(rateAmt);
		console.log('Qty: id => '+id+' : Cnt => '+cnt+' : qty => '+qty+' : rate => '+rate+' : rateAmt => '+rateAmt);
	});
	...
	$(document).on("keyup",'input[name="rate[]"]',function () {	
		...
		var cnt = id[id.length -1];
		if(cnt == 1)
			var qty = $("#qty1").val();
		else
			var qty = $("#qty1_"+cnt).val();
		...
		if(qty == '' || rate == '')
			...
			$("#qty_rate"+cnt).val(rateAmt);
		console.log('Rate: id => '+id+' : Cnt => '+cnt+' : qty => '+qty+' : rate => '+rate+' : rateAmt => '+rateAmt);
	});
    ...
    $(document).ready(function () {
        ...
        var baseinvoice = <?php echo $i_nox; ?>;
        var x = 1; //initlal text box count
        $(add_button).click(function (e) { //on add input button click
            e.preventDefault();
            if (x < max_fields) { //max input box allowed
                ...
                $(wrapper).append('<div class="form-group" style="margin-top:20px;"><hr/> <div class="row"><div class="col-md-2"><input type="text" name="invoice_no[]" value="INV0'+ (baseinvoice + x - 1) +'" readonly="readonly" class="form-control invoice_no"/><input type="text" name="rd" value="patients" style="display:none;"/></div><div class="col-md-2"> <select name="treatment_Advised_id[]" class="form-control chzn"  onchange="updatePrice(this, '+x+')" > <option value="">--<?php echo lang('treatment_advised'); ?>--</option> <?php //multiple="multiple"
                    foreach ($treatment_Advised as $new){
                        $sel="";
                        echo '<option value="' . $new->name .'" data-price="'. $new->price.'" >'. $new->name .'</option>';
                    }
                    ?> </select> </div> <div class="col-md-2"> <input type="text" id="tooth'+ x +'" value="" class="form-control amount" style="cursor:pointer;" onclick="{teeth_row = '+ x +';$(`#add_inv2`).modal(`toggle`);}" readonly=""/> <input type="hidden" id="teeth'+ x +'" name="teeth[]" value="" class="form-control amount"/> </div><div class="col-md-1"> <input type="text" id="qty1_'+ x +'" name="qty[]" value="" class="form-control amount" style="padding: 2px;" /> </div><div class="col-md-3"> <input type="text" id="amt'+x+'" name="rate[]" value="" class="form-control amount"  style="padding: 2px; width:45%; float:left;" /> <input type="text" id="qty_rate'+x+'" name="qty_rate[]" value="" class="form-control amount" style="padding: 2px; width:45%; float:right;" /> </div><div class="col-md-2"><input type="text" name="amount12[]" value="" id="ashu" class="form-control amount" placeholder="Amount"/></div><div class="col-md-2"><a href="#" class="remove_field_inv btn btn-danger"><?php echo lang('remove'); ?></a></div> </div></div></div></div>'); //add input box
					$(".chzn").chosen();
            }
        });
    ...
    $(document).ready(function () {
        ...
        $(add_button).click(function (e) { //on add input button click
            ...
            if (x < max_fields) { //max input box allowed
                x++; //text box increment
                $(wrapper).append('<div class="form-group" style="margin-top:20px;"><hr/> <div class="row"> <div class="col-md-2"> <select name="payment_mode_id[]" class="form-control payment payment_mode_id" onchange="payment_made_inv(this);" > <option value="">--<?php echo lang('select') ?> <?php echo lang('payment_mode') ?> --</option> <?php
                    foreach ($payment_modes as $new) {
                        $sel = "";
                        echo '<option value="' . $new->id . '" ' . $sel . '>' . $new->name . '</option>';
                    }
                    ?> </select> </div><div class="payment_mode"></div></div><a href="#" class="remove_field_inv btn btn-danger"><?php echo lang('remove'); ?></a></div></div></div>'); //add input box
            }
        });
    ...
    $(document).ready(function () {
        ...
        $(add_button).click(function (e) { //on add input button click
            ...
            if (x < max_fields) { //max input box allowed
                x++; //text box increment
                $(wrapper).append('<div class="row"><div class="col-md-2"></div><div class="col-md-3"><select name="intra_Oral_Exm_id[]" class="form-control chzn"><option value="">--<?php echo 'Select an option'; ?>--</option><?php
                    foreach ($intra_Oral_Exm as $new) {
                        echo '<option value="' . $new->name . '">' . $new->name . '</option>';
                    }
                    ?></select></div><div class="col-md-3"><select name="intra_Oral_Exm_' + x + '[]" class="form-control chzn" multiple="multiple" data-placeholder="Select an option"><?php
                    foreach ($treatment_Advised_ins as $new) {
                        echo '<option value="' . $new->name . '">' . $new->name . '</option>';
                    }
                    ?></select></div><a href="#" class="remove_field3 btn btn-danger"><?php echo lang('remove'); ?></a></div></div>'); //add input box
...
<script>
    ...
    $(".btnAddNote").on("click", function(){
        $("#trtHeader").text("Add Note")
        $("#trtId").val($(this).attr("data-id"));
        $("#treatNote").val("");
    })

    $(".btnEditNote").on("click", function(){
        var data = JSON.parse( $(this).attr("data-id"))
        $("#trtHeader").text("Edit Note")
        $("#trtId").val(data.id);
        $("#treatNote").val(data.notes);
    })

    $(".btnPaymentNote").on("click", function(){
        
        var data = JSON.parse( $(this).attr("data-id"))
        $("#trtHeader").text("Payment Note")
        $("#treatIdPaymentNote").val(data.id);
        $("#txtPaymentNote").val(data.payment_notes);
    })
    ...
    $("#btnSubmit").on("click",function(){
        ...
        $.post("<?php echo site_url('admin/patients/addNote/')?>",Info,function(data){
            location.reload(true);
        });
    })

    $("#btnSubmitPaymentNote").on("click",function(){
        var Info={
            treatId:$("#treatIdPaymentNote").val(),
            note: $("#txtPaymentNote").val()
        }
        $.post("<?php echo site_url('admin/patients/addPaymentNote/')?>",Info,function(data){
           location.reload(true);
	...
	function getTreatmentPlan(id) {
		console.log('ID : '+id);
        $.ajax({
			  url: '<?php echo base_url('admin/patients/edit_treatment_plan') ?>',
			  type: 'POST',
			  data: {id: id},
			  success: function (result) {
				  //alert(result);return false;
				  ...
				  $("#edit_treatment_plan").modal('show');
...
<script>
	...
	function calclulate_edit_total(invId)
	{
		var qty = $('#edit_qty_'+invId).val();
		var rate = $('#edit_rate_'+invId).val();
		...
		//var amount = $('edit_amount_'+invId).val();
		if (typeof amt !== "undefined") {
			$('#edit_amount_'+invId).val(amt);
		}
	}
	function calclulate_received_total(invId)
	{
		var recived = $('#edit_credit_'+invId).val();
		$('#edit_amount_pay_'+invId).val(recived);
	}
	function open_print_invoice(modalId)
	{
		$('#'+modalId).modal('show');
		invoice_total_edit();
	}
