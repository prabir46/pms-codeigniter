...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo "medicine template";?></li>
    </ol>
</section>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo "medicine template";?></h3>
                </div><!-- /.box-header -->
                                ...
                                <tr class="gc_row">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <a class="btn btn-danger"  href="<?php echo site_url('admin/medicine_template/delete/'.$new->id); ?>" onclick="return areyousure()"><i class="fa fa-trash"></i> <?php echo lang('delete');?></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php $i++;}?>
...
<?php if(isset($case_historys)):?>
    ...
    foreach ($case_historys as $new){
        $case_history = $this->drug_allergy_model->get_case_history_by_id1($new->id);
        ?>
        <!-- Modal -->
            ...
            <div class="modal-dialog">
                <div class="modal-content ff">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="editlabel"><?php echo lang('edit');?> <?php echo "medicine template"?></h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <?php echo form_open_multipart('admin/medicine_template/edit/'.$case_history->id); ?>
                        ...
                        <div class="box-body">
                            ...
                            <?php
                            $medicine1 = json_decode($case_history->medicine);
                            $medi_ins1 = json_decode($case_history->medicine_instruction);
                            $frequnecy = json_decode($case_history->frequnecy);
                            $duration = json_decode($case_history->duration);
                            //echo '<pre>'; print_r();
                            //echo '</pre>';
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <select name="frequency[]" class="form-control ">
                                                    ...
                                                    <option value="0-0-1"  <?php echo ($frequency[@$key] == "0-0-1") ? 'selected' : ''; ?>>0-0-1</option>
                                                    <option value="1-0-0" <?php echo ($frequency[@$key] == "1-0-0") ? 'selected' : ''; ?>>1-0-0</option>
                                                    <option value="1-0-1" <?php echo ($frequency[@$key] == "1-0-1") ? 'selected' : ''; ?>>1-0-1</option>
                                                    <option value="1-1-1" <?php echo ($frequency[@$key] == "1-1-1") ? 'selected' : ''; ?>>1-1-1</option>
            ...
            <div class="modal-dialog">
                <div class="modal-content ff">
                    <div class="modal-header">
                        ...
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="editlabel"><?php echo lang('view');?> <?php echo "medicine template"?></h4>
                    </div>
                    <div class="modal-body">
                        <div class="box-body">
                            <div class="form-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content ff">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="<?php echo base_url();?>admin/medicine_template/add">
                    <div class="box-body">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-4">
...
//$(this).closest("form").submit();
        ...
        call_loader_ajax();
        $.ajax({
            url: '<?php echo site_url('admin/medicine_template/edit') ?>/' + id,
            type:'POST',
            data:{name:name},
...
<?php echo lang('select_medicine'); ?>--</option><?php
                    ...
                    ?></select></div>\n\
                                        <div class="col-md-2"><select name="frequency[]" class="form-control "><option value="">-- Frequency for Medicine --</option><option value="0-0-1">0-0-1</option><option value="1-0-0">1-0-0</option><option value="1-0-1">1-0-1</option><option value="1-1-1">1-1-1</option><option value="Four times a day">Four times a day</option><option value="At Night">At Night</option><option value="At Morning">At Morning</option><option value="At Noon">At Noon</option></select></div>\n\
