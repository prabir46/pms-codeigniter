...
function areyousure()
{
	return confirm('Are You Sure You Want Delete This Hospital ?');
}
</script>
                                ...
                                <tr class="gc_row">
									...
									<td width="27%">
									 <div class="btn-group">
                                         ...
                                         <a class="btn btn-danger" style="margin-left:20px;" href="<?php echo site_url('admin/hospital/delete/'.$new->id); ?>" onclick="return areyousure()"><i class="fa fa-trash"></i> <?php echo lang('delete');?></a>
										 <a class="btn btn-default" style="display:none"  href="<?php echo site_url('admin/hospital/manage/'.$new->id); ?>"><i class="fa fa-arrows"></i> <?php echo lang('manage');?></a>
                                        </div>
      ...
      <div class="modal-body">
	   <div id="err_edit<?php echo $new->id?>">  
		...
		<?php  } ?>  
				...
				<form method="post" action="<?php echo site_url('admin/hospital/edit/'.$hospital_details->id)?>"?>
...
$( "#add_hospital" ).submit(function( event ) {
	...
	call_loader_ajax();	
	$.ajax({
		url: '<?php echo site_url('admin/hospital/add/') ?>',
		type:'POST',
...
//$(this).closest("form").submit();	
	...
	call_loader_ajax();
	$.ajax({
		url: '<?php echo site_url('admin/hospital/edit') ?>/' + id,
		type:'POST',
		data:{name:name,address:address,phone:phone},
		success:function(result){
		//alert(result);return false;
