...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('admin/manufacturing_company')?>"> <?php echo lang('manufacturing_company');?></a></li>
...
<?php  } ?>  
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
				...
				<?php echo form_open_multipart('admin/manufacturing_company/edit/'.$id); ?>
                    <div class="box-body">
                        <div class="box-body">
						 ...
						 <div class="form-group">
                        	<div class="row">
                                <div class="col-md-3">
									...
									<input type="text" name="from"  class="form-control" id="date_timepicker_start"  value="<?php echo $category->start_date; ?>" />
                                </div>
                            
                                <div class="col-md-3">
                                    <label for="name" style="clear:both;"> <?php echo lang('to');?></label>
									<input type="text" name="to"  class="form-control"  id="date_timepicker_end"  value="<?php echo $category->end_date; ?>"/>
                                </div>
                            </div>
                        </div>
