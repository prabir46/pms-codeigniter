...
<?php  } ?>  
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
				...
				<?php echo form_open_multipart('admin/manufacturing_company/add/'); ?>
                    <div class="box-body">
						 ...
						 <div class="form-group">
                        	<div class="row">
                                <div class="col-md-3">
									...
									<input type="text" name="from"  class="form-control" id="date_timepicker_start"  />
                                </div>
                            
                                <div class="col-md-3">
                                    <label for="name" style="clear:both;"> <?php echo lang('to');?></label>
									<input type="text" name="to"  class="form-control"  id="date_timepicker_end" />
                                </div>
                            </div>
                        </div>
