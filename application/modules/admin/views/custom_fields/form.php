				...
				<form method="post" enctype="multipart/form-data"  action="<?php echo site_url('admin/custom_fields/')?>"
                        	...
                        	<div class="row">
								...
								<div class="col-md-4">
                                	<select name="form" class="form-control">
										...
										<option value="1"><?php echo lang('doctors')?></option>
										<option value="2"><?php echo lang('patients')?></option>
										<option value="3"><?php echo lang('to_do')?></option>
										<option value="4"><?php echo lang('contacts')?></option>
										<option value="5"><?php echo lang('prescription')?></option>
                                        <option value="6"><?php echo lang('lab_management')?></option>
									</select>    
								</div>
							 </div>
                        </div>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
							...
							if($new->form==1){
								$form_new=lang('doctors');
							}
							if($new->form==2){
								$form_new =lang('patients');
							}
							if($new->form==3){
								$form_new =lang('to_do');
							}
							...
							if($new->form==5){
								$form_new =lang('prescription');
							}
							if($new->form==6){
								$form_new =lang('lab_management');
							}
