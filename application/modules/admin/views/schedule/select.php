...
<?php  } ?>  
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
				...
				<?php echo form_open_multipart('admin/schedule/select_weekly_monthly/'); ?>
                    <div class="box-body">
                       
		<div class="row">
            <div class="col-md-12">
              	<label>Select Weekly Schedule /Monthly Schedule</label>
        	</div>
		</div>
        <div class="row">
				<div class="col-md-12">   <input type="radio" name="fixed_type" value="1">Weekly<br/>
				<input type="radio" name="fixed_type" value="2">Monthly<br/>
				</div>
		</div>
