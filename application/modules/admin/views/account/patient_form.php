                        ...
                        <div class="form-group">
                        	...
                        	<div class="row">
                                <div class="col-md-3">
								 ...
								 if(!empty($image)){
								 ?>
								 <img src="<?php echo base_url('assets/uploads/images/'.$image);?>" height="70" width="70" />
								 <?php 
								 	}else{
									echo "-";
									}
                        ...
                        <div class="form-group">
                              <div class="row">
                                <div class="col-md-3">
									...
									<?php
                                    $data	= array('name'=>'username', 'value'=>set_value('username', $username), 'class'=>'form-control', 'id'=>'username');
                                    echo form_input($data);
                                    ?>
...
$("#username").on('blur',function() {   
    ...
    var id  = <?php echo $id?>; 
	 if(val){
		...
		type:'POST',
		data:{username:val,id:<?php echo $id?>},
