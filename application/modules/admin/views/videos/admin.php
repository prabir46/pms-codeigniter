            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="panel-body" style="margin-left: 10px;">
                    ...
                    <div class="row">
                        ...
                        <a class="btn btn-default pull-right" href="#popupadd" data-toggle="modal" style="margin-top: 20px;margin-right: 5%;"><i class="fa fa-plus"></i> Add New </a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" id="Cancel" data-dismiss="modal" class="btn btn-sm pull-right btn-primary"><i class="fa fa-times"></i></button>
                        <h3 class="modal-title heading_modal "> Add Video </h3>
                    </div>
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                          <div class="row">
                                            <div class="col-md-8">
                                                <label for="dob" style="clear:both;">Short Link</label>
           ...
           $(document).ready(function () {
                ...
                $( "#add_form" ).submit(function( event ) {
                    ...
                    {  
                        ...
                        alert('This is not a proper link!');
                        return false;
                    }

                    call_loader_ajax();
                    $.ajax({
                        url: '<?php echo site_url('admin/videos/add'); ?>',
                        type:'POST',
                        data:{'title':title,'key':key,'link':link},
