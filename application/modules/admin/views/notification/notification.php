        ...
        <div class="col-md-12">
			...
			<?php /*			
						<div class="form-group">
                        	<div class="row">
                                <div class="col-md-3">
                                	<b><?php echo lang('schedule_setting');?></b>
								</div>
								<div class="col-md-4">
                                    <input type="radio" name="schedule" value="0" <?php echo ($settings->schedule==0)?'checked="checked"' : '' ?>/> Weekly   &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;				 
									<input type="radio" name="schedule" value="1" <?php echo ($settings->schedule==1)?'checked="checked"' : '' ?>/> Monthly
