...
?></td>
								    ...
								    <td width="30%">
                                        <div class="btn-group">
										  ...
										  <a class="btn btn-primary" style="margin-left:10px;"  href="<?php echo site_url('admin/inventory_management_order/edit/'.$new->id); ?>" data-toggle="modal"><i class="fa fa-edit"></i> <?php echo lang('edit');?></a>
                                         <a class="btn btn-danger" style="margin-left:20px;" href="<?php echo site_url('admin/inventory_management_order/delete/'.$new->id); ?>" onclick="return areyousure()"><i class="fa fa-trash"></i> <?php echo lang('delete');?></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php $i++;}?>
      ...
      <div class="modal-body">
	   <div id="err">
		...
		<?php  } ?>
      				   ...
      				   <!-- form start -->
				<form method="post" action="<?php echo site_url('admin/inventory_management_order/add/')?>" enctype="multipart/form-data" id="add_form">
...
$sel = "";
	...
	echo '<option value="'.$new->id.'" '.$sel.'>'.$new->name.'</option>';
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <input type="text" id="name1" name="name[]" value="" class="form-control amount" />
                        </div>
                        <div class="col-md-4">
                            <input type="text" id="qty1" name="quantity[]" value="" class="form-control amount" />
                        </div>
                        <br><br>
                    </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="pull-right" style="padding-left:12px;">
                                    <button type="button" class="add_field_button_invoice_1 btn btn-success"><?php echo lang('add'); ?> </button>
                                </div>
                            </div>
                        </div>
