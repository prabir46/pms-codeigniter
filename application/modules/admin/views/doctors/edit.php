                        ...
                        <div class="form-group">
                        	<div class="row">
                                <div class="col-md-4">
									...
									<input type="text" name="name" value="<?php echo $doctor->name?>" class="form-control">
                                </div>
                            </div>
                        </div>
                                    ...
                                    <label for="name" style="clear:both;"><?php echo lang('blood_type');?></label>
									   <select name="blood_id" class="form-control chzn">
											...
											<?php foreach($groups as $new) {
													$sel = "";
													if($new->id==$doctor->blood_group_id) $sel = "selected='selected'";
			   			 ...
			   			 <div class="form-group">
                              <div class="row">
                                <div class="col-md-4">
									...
									<input type="text" name="dob" id="datepicker" value="<?php echo $doctor->dob?>"class="form-control datepicker">
                        ...
                        <div class="form-group">
                              <div class="row">
                                <div class="col-md-4">
									...
									<input type="text" name="email" value="<?php echo $doctor->email?>" class="form-control">
                                </div>
                            </div>
                        </div>
						...
						<div class="form-group">
                              <div class="row">
                                <div class="col-md-4">
									...
									<input type="text" name="username" value="<?php echo $doctor->username?>" class="form-control">
                                </div>
                            </div>
                        </div>
						 ...
						 <div class="form-group">
                              <div class="row">
                                <div class="col-md-4">
									...
									<input type="text" name="contact" value="<?php echo $doctor->contact?>" class="form-control">
                                </div>
                            </div>
                        </div>
						 ...
						 <div class="form-group">
                              <div class="row">
                                <div class="col-md-4">
									...
									<textarea name="address"  class="form-control"><?php echo $doctor->address?></textarea>
                                </div>
                            </div>
                        </div>
					<?php 
