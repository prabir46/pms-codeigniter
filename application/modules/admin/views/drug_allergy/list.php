...
<section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo lang('drug_allergy');?></li>
        </ol>
</section>
  ...
  <div class="modal-dialog">
    <div class="modal-content ff">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="editlabel"><?php echo lang('add');?> <?php echo lang('drug_allergy')?></h4>
      </div>
      <div class="modal-body">
	   <div id="err">  
				<?php 
...
$( "#add_form" ).submit(function( event ) {
	...
	call_loader_ajax();
	$.ajax({
		url: '<?php echo site_url('admin/drug_allergy/add/') ?>',
		type:'POST',
		data:{name:name},
