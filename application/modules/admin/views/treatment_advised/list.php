...
<section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo lang('treatment_advised');?></li>
        </ol>
</section>
          ...
          <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo lang('treatment_advised');?></h3>                                    
                </div><!-- /.box-header -->
                                ...
                                <tr class="gc_row">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                         ...
                                         <a class="btn btn-danger"  href="<?php echo site_url('admin/treatment_advised/delete/'.$new->id); ?>" onclick="return areyousure()"><i class="fa fa-trash"></i> <?php echo lang('delete');?></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php $i++;}?>
...
$case_history = $this->treatment_advised_model->get_case_history_by_id($new->id);
?>
<!-- Modal -->
  ...
  <div class="modal-dialog">
    <div class="modal-content ff">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="editlabel"><?php echo lang('edit');?> <?php echo lang('treatment_advised')?></h4>
      </div>
      <div class="modal-body">
		...
		<?php  } ?>  
		   ...
		   <?php echo form_open_multipart('admin/treatment_advised/edit/'.$case_history->id); ?>
                 <input type="hidden" name="id" value="<?php echo $case_history->id?>" />
				    <div class="box-body">
                         ...
                         <div class="form-group">
                        	<div class="row">
                                <div class="col-md-4">
                                    <label for="price" style="clear:both;"> Price</label>
									<input type="text" name="price" value="<?php echo set_value('name') . $case_history->price?>" class="form-control price">
                                </div>
                            </div>
                        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content ff">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="editlabel"><?php echo lang('view');?> <?php echo lang('treatment_advised')?></h4>
      </div>
      <div class="modal-body">
                    <div class="box-body">
                         <div class="form-group">
                         ...
                         <div class="form-group">
                        	<div class="row">
                                <div class="col-md-2">
                                    <label for="name" style="clear:both;"> Price</label>
								</div>
								<div class="col-md-6">
										<?php echo $case_history->price?>
                                </div>
                            </div>
                        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content ff">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="editlabel"><?php echo lang('add');?> <?php echo lang('treatment_advised')?></h4>
      </div>
      <div class="modal-body">
	   <div id="err">  
				<?php 
...
$( "#add_form" ).submit(function( event ) {
	...
	call_loader_ajax();
	$.ajax({
		url: '<?php echo site_url('admin/treatment_advised/add/') ?>',
		type:'POST',
...
//$(this).closest("form").submit();	
	...
	call_loader_ajax();
	$.ajax({
		url: '<?php echo site_url('admin/treatment_advised/edit') ?>/' + id,
		type:'POST',
		data:{name:name,price:price},
