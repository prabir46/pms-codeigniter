...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('admin/message')?>"><?php echo lang('select');?> <?php echo lang('patient');?></a></li>
            ...
            <div class="box box-primary">
                            ...
                            <div class="box box-success">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title"><?php echo lang('message');?> <?php echo lang('to');?> <?php echo lang('doctor');?></h3>
							 ...
							 <?php $i=1;foreach ($messages as $new){?>		
									...
									<?php }?>	
                                        <p class="message" style="padding-top:12px;">
                                            ...
                                            <a href="#" class="name">
                                                <small class="text-muted pull-right"><i class="fa fa-clock-o"></i> <?php echo date("d/m/y h:i a", strtotime($new->date_time)); ?>  </small>
