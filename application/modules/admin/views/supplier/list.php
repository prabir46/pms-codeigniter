...
<section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo lang('supplier');?></li>
        </ol>
</section>
          ...
          <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo lang('supplier');?></h3>                                    
                </div><!-- /.box-header -->
                                ...
                                <tr class="gc_row">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                         ...
                                         <a class="btn btn-danger" style="margin-left:20px;" href="<?php echo site_url('admin/supplier/delete/'.$new->id); ?>" onclick="return areyousure()"><i class="fa fa-trash"></i> <?php echo lang('delete');?></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php $i++;}?>
...
<?php $i=1;
foreach ($name as $new){
$name = $this->supplier_model->get_medicine_category_by_id($new->id);
  ...
  <div class="modal-dialog">
    <div class="modal-content ff">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="editlabel"><?php echo lang('edit');?> <?php echo lang('supplier')?></h4>
      </div>
	  ...
	  <div id="err_edit<?php $name->id ?>">  
		...
		<?php echo form_open_multipart('admin/supplier/edit/'.$name->id); ?>
                    <div class="box-body">
                        <input type="hidden" name="id" value="<?php echo $name->id?>" />
						<div class="form-group">
                        	<div class="row">
                                <div class="col-md-4">
                                    <label for="name" style="clear:both;"> <?php echo lang('supplier');?></label>
									<input type="text" name="name" value="<?php echo $name->name; ?>" class="form-control name">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="name" style="clear:both;">Mobile</label>
                                    <input type="text" name="mobile" value="<?php echo set_value('mobile') . $name->mobile ?>" class="form-control name">
                                </div>
                            </div>
                        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content ff">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="editlabel"><?php echo lang('view');?> <?php echo lang('supplier')?></h4>
      </div>
      <div class="modal-body">
	  <div id="err">  
				<?php 
  ...
  <div class="modal-dialog">
    <div class="modal-content ff">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="editlabel"><?php echo lang('add');?> <?php echo lang('supplier')?></h4>
      </div>
      <div class="modal-body">
					...
					<div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="name" style="clear:both;">Mobile</label>
                                    <input type="text" name="mobile" value="<?php echo set_value('mobile')?>" class="form-control name">
                                </div>
                            </div>
                        </div>
...
$( "#add_form" ).submit(function( event ) {
	...
	call_loader_ajax();
	$.ajax({
		url: '<?php echo site_url('admin/supplier/add/') ?>',
		type:'POST',
