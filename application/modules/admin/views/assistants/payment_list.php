          ...
          <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo lang('payment_for_assistant')?></h3>                                    
                </div><!-- /.box-header -->
									...
									<table width="100%" style="border-bottom:1px solid #CCCCCC; padding-bottom:20px;">
										...
										<img src="<?php echo base_url('assets/img/doctor_logo.png/')?>"  height="70" width="80" />
											...
											<td align="right">
												...
												<b><?php echo lang('issue_mode') ?>:</b> <?php echo date('d/m/Y')?><br />
											</td>
										</tr>
									</table>
								</td>
...
<?php $i=1;
foreach ($payments as $new){
$payment = $this->assistant_model->get_payment_by_id($new->id);
?>
<!-- Modal -->
		              ...
		              <div class="form-group" style="margin-top:20px;"> 
						...
						<div class="form-group" style="margin-top:20px;">
                        	<div class="row">
								...
								<div class="col-md-4">
                                    <select name="assistant_id" class="form-control chzn assistant_id">
											<option value="">--Select Assistant--</option>
											<?php foreach($assistants as $new) {
													$sel = "";
													if($payment->assistant_id==$new->id) $sel = "selected='selected'";
...
//$(this).closest("form").submit();	
	...
	call_loader_ajax();
	$.ajax({
		url: '<?php echo site_url('admin/assistant_payment/edit_payment') ?>/' + id,
		type:'POST',
		data:{assistant_id:assistant_id,invoice_no:invoice_no,amount:amount,payment_mode_id:payment_mode_id,date:date},
		success:function(result){
