...
class prescription_model extends CI_Model {
    ...
    function get_prescription_id_api() {
        $admin = $_POST;
        $this->db->where('U.doctor_id', $admin['id']);
        $this->db->select_max('P.prescription_id');
        $this->db->join('users U', 'U.id = P.patient_id', 'LEFT');
    ...
    function get_invoice_number_by_doctor($doctor_id){
        $this->db->where('doctor_id', $doctor_id);
        $this->db->like('invoice','INV');
        $this->db->select_max('invoice');
        return $this->db->get('payment_fees')->row();
    }

    function get_receipt_number_by_doctor($doctor_id){
        $this->db->where('doctor_id', $doctor_id);
        $this->db->like('invoice','RCT');
        $this->db->select_max('invoice');
        return $this->db->get('payment_fees')->row();
    }
